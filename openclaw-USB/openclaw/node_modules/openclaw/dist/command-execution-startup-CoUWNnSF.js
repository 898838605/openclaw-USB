...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-Cj6MsN0t.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-D6POpiGO.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-C4KB0CrU.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-DukClexp.js");
	if (params.argv) {
