import{et as e,i as t,nt as n,rt as r}from"./index-quv2B8bV.js";function i(i){let a=(i.status&&typeof i.status==`object`?i.status.securityAudit:null)?.summary??null,o=a?.critical??0,s=a?.warn??0,c=a?.info??0,l=o>0?`danger`:s>0?`warn`:`success`,u=o>0?e(`debug.security.critical`,{count:String(o)}):s>0?e(`debug.security.warnings`,{count:String(s)}):e(`debug.security.noCriticalIssues`);return r`
    <section class="grid">
      <div class="card">
...
//# sourceMappingURL=debug-D-k42Sr-.js.map