...
import { _ as resolveSessionAgentId, v as resolveSessionAgentIds } from "./agent-scope-Cf7T6Ju7.js";
...
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir } from "./agent-scope-config-DUwbsKjv.js";
import { s as normalizeStringEntries } from "./string-normalization-DgUPESoD.js";
import { n as parseGitPluginSpec, t as installPluginFromGitSpec } from "./git-install-B24OeiUT.js";
import { t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-DR3h__QQ.js";
import { t as parseClawHubPluginSpec } from "./clawhub-spec-C0z3kReV.js";
import { c as resolveOfficialExternalPluginInstall, n as getOfficialExternalPluginCatalogEntryForPackage, s as resolveOfficialExternalPluginId } from "./official-external-plugin-catalog-DBaj9fiE.js";
...
import { M as resetConfigOverrides, N as setConfigOverride, P as unsetConfigOverride, T as validateConfigObjectWithPlugins, j as getConfigOverrides, u as readConfigFileSnapshot } from "./io-DnGGugrj.js";
import { s as resolveArchiveKind } from "./archive-BIRRxQjC.js";
import "./archive-CBTii-y1.js";
import "./installed-plugin-index-records-BEXTtiS3.js";
import { _ as resolveResponseUsageMode, h as normalizeUsageDisplay, u as isSessionDefaultDirectiveValue } from "./thinking-CvQif4jm.js";
import { n as assertConfigWriteAllowedInCurrentMode } from "./nix-mode-write-guard-DxCJ9lzV.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-DZHM3IlU.js";
import { t as setPluginEnabledInConfig } from "./toggle-config-Wb4zXDz0.js";
import { t as parseDurationMs } from "./parse-duration-uDFt9RSx.js";
import { o as transformConfigFileWithRetry } from "./mutate-DyuMRjr1.js";
import "./config-CR6nsEzH.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-CYCjqSrD.js";
...
import { r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-JqYBZqnL.js";
import { i as callGateway } from "./call-NAbH1Jz8.js";
import { f as scheduleGatewaySigusr1Restart, h as triggerOpenClawRestart } from "./restart-x8yr89ni.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime, c as resolveContextConfigProviderForRuntime } from "./openai-codex-routing-17ICsBr_.js";
import { t as resolveAgentHarnessPolicy } from "./policy-DYe4G92j.js";
import { t as getActivePluginChannelRegistry } from "./runtime-nSi6iKFR.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-Ci62WSre.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-RbVDOqFp.js";
import { t as loadSessionStore } from "./store-load-DjaY7SAt.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-OCFvwkK7.js";
import { s as updateSessionStore } from "./store-CmwzJ9N6.js";
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-Cs-ACH2d.js";
import { o as resolveFreshSessionTotalTokens } from "./types-CvORIrpN.js";
import { u as extractDeliveryInfo } from "./sessions-BDnaolrd.js";
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-BEv_N5f2.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-Bzn5r2hY.js";
...
import { a as isNativeCommandTurn, s as resolveCommandTurnContext } from "./command-turn-context-BtFH5p2Y.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-BE7EsYqI.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-tc_il70a.js";
import { f as replyRunRegistry } from "./reply-run-registry-CcD5OkAB.js";
import "./diagnostic-Czpecr1T.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-rEHx3OX2.js";
import { a as getActiveEmbeddedRunSnapshot, d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary, o as isEmbeddedPiRunActive, p as resolveActiveEmbeddedRunSessionId } from "./runs-CfIOZroM.js";
import { r as isSilentReplyPayloadText } from "./tokens-BlOFOAQM.js";
import { n as estimateTokensFromChars } from "./cjk-chars-BRUBfQGD.js";
import { a as resolveContextTokensForModel } from "./context-BOq-RKZX.js";
import { i as formatUsd, r as formatTokenCount } from "./usage-format-CA9pmIOM.js";
...
import { r as getSessionBindingService } from "./session-binding-service-CYOKTouv.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-D-UWDWG8.js";
import { i as selectAgentHarness, n as resolveAvailableAgentHarnessPolicy } from "./selection-Cr-9-UpD.js";
import { t as formatDurationCompact } from "./format-duration-CfCsYxBe.js";
import { o as getFinishedSession, s as getSession } from "./bash-process-registry-MVHTiscQ.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-OP6llAL2.js";
import { h as resolveBootstrapTotalMaxChars, p as resolveBootstrapMaxChars } from "./pi-embedded-helpers-BceuaEk2.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-CM7YOmsC.js";
import { r as getApiKeyForModel } from "./model-auth-DOcJ8K8t.js";
...
import { n as routeReply } from "./route-reply-W4EDpsmT.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-DBgfYxUW.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-DJGvoo6P.js";
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, a as getTtsMaxLength, b as setLastTtsAttempt, c as isSummarizationEnabled, f as listTtsPersonas, i as getResolvedSpeechProviderConfig, k as textToSpeech, l as isTtsEnabled, o as getTtsPersona, r as getLastTtsAttempt, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsPrefsPath, w as setTtsMaxLength, x as setSummarizationEnabled } from "./tts-runtime-BVVdE3da.js";
import "./tts-BjNB0m2z.js";
import { t as registerProviderStreamForModel } from "./provider-stream-D4qSxrOO.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-CPpXRm84.js";
import { a as stripToolResultDetails } from "./session-transcript-repair-BUFdKx9z.js";
import "./sandbox-BWb_xyE6.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-DvbTO3Be.js";
...
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-Bt3D_UfY.js";
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-kHzcuhlz.js";
import "./commands-registry-QgNf4rX0.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-DZxlOMaP.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-CSIjZAQb.js";
import { r as resolveModelWithRegistry } from "./model-CjE75UNk.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-7feHeE6H.js";
import { i as stopSubagentsForRequester, n as formatAbortReplyText, r as resolveSessionEntryForKey, t as abortSessionRunTarget } from "./abort-CQTeoXhD.js";
import { t as isApprovalNotFoundError } from "./approval-errors-CsA9WUQT.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-BdI3fczN.js";
import { n as formatTimeAgo } from "./format-relative-DhnCP6Cs.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-DlvcWZy9.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-CX-8tne7.js";
import { t as handleCrestodianCommand } from "./commands-crestodian-B0TTF237.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-BHUSy2xY.js";
import { n as parseActivationCommand } from "./group-activation-CJMkhaCv.js";
import { t as resolveFastModeState } from "./fast-mode-CJ-bUYWt.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-ulTEDq0J.js";
import { t as extractExplicitGroupId } from "./group-id-C-dYFRyt.js";
import { t as formatElevatedUnavailableMessage } from "./elevated-unavailable-XP7nNzSm.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-DEWU-vcQ.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-ChfoKBeL.js";
import { t as extractBtwQuestion } from "./btw-command-DMSU_v4W.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-CTnxCDyh.js";
import { a as requireGatewayClientScope, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-DYjGks13.js";
import { t as handleAcpCommand } from "./commands-acp-C_-oqM58.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-BCWWB7Gi.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-C8N_meQ_.js";
import { r as handleModelsCommand } from "./commands-models-CJ3GghDD.js";
import { r as createExecTool } from "./bash-tools-BOznQu4J.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./task-status-access-CBjiD40_.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-DV5v2jAz.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-B9cj9S72.js";
import { t as buildToolsMessage } from "./status-BN3sprt4.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-2okK3J98.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-B353cLWa.js";
import "./command-export-1Scqp9JP.js";
import { t as buildStatusReply } from "./commands-status-DW7i2gnC.js";
import { n as persistPluginInstall, r as buildNpmInstallRecordFields } from "./plugins-install-persist-nOrHWqjf.js";
import { a as installPluginFromNpmSpec, o as installPluginFromPath } from "./install-Ddu7RW8R.js";
import { a as resolveOfficialExternalNpmPackageTrust } from "./plugin-install-plan-CLxm6Stl.js";
import { a as buildPluginDiagnosticsReport, l as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginRegistrySnapshotReport, t as buildAllPluginInspectReports } from "./status-S29B5mY4.js";
import { d as resolveFileNpmSpecToLocalPath, r as createPluginInstallLogger } from "./plugins-command-helpers-Db3gQKqs.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-D-eB9lNA.js";
import "./clawhub-fpZxNGuO.js";
import { r as installPluginFromClawHub } from "./clawhub-CMMKp9h9.js";
import { i as loadSessionCostSummary, n as loadCostUsageSummary } from "./session-cost-usage-iiOVUp-2.js";
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-CBHSDpkF.js");
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-B96D9kFM.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-BXf04njD.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-BQOKSwRN.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-CONdlsr6.js"));
const actionKillLoader = createLazyImportLoader(() => import("./action-kill-KzV-RHZO.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-iaz866sn.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-95U5DO6p.js"));
const actionSendLoader = createLazyImportLoader(() => import("./action-send-BoWJkKIc.js"));
const actionSpawnLoader = createLazyImportLoader(() => import("./action-spawn-zuuArCTv.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-L20Ic5yw.js"));
const controlRuntimeLoader = createLazyImportLoader(() => import("./commands-subagents-control.runtime-DI-Ex8uz.js"));
