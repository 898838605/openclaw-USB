...
import { c as resolveDefaultAgentId, o as resolveAgentWorkspaceDir } from "./agent-scope-config-DUwbsKjv.js";
import { n as defaultRuntime, r as writeRuntimeJson } from "./runtime-DDH_zqCr.js";
import { o as getResolvedLoggerSettings } from "./logger-ApTu_tEr.js";
import { t as danger } from "./globals-BmUmhyAe.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-DnGGugrj.js";
import { i as replaceConfigFile } from "./mutate-DyuMRjr1.js";
...
import { i as getBundledChannelSetupPlugin } from "./bundled-DowL9sGd.js";
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-OCFvwkK7.js";
import "./plugins-Cs-ACH2d.js";
import "./logging-B8QGVK5v.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-CzEtaKcj.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-CxOvXCpK.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-CuSrA8o7.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-DrdxqwF3.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-hz2yLOgH.js";
import { o as getChannelsCommandSecretTargetIds } from "./command-secret-targets-aoyOGHQ6.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-K12HMjYn.js";
...
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-DXg9bibK.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-VgZRtn3f.js";
import { n as resolveLogFile } from "./log-tail-0DgjOjut.js";
import { t as parseLogLine } from "./parse-log-line-DUivcBNW.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-CpTTCtvM.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-hz8_G-HK.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-CDjsLuPZ.js";
import { t as channelsListCommand } from "./list-CRklU5ro.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-DwUdfBla.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-DmoXtYQQ.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-DvvGYfDH.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-Bha6oyj2.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-CjfX3wPs.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-B-sQxR6a.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-1Az0lh5n.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-C6242lAO.js");
