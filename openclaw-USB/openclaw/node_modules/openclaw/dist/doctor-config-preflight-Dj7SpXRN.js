...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-DnGGugrj.js";
import { n as formatConfigIssueLines } from "./issue-format-BTP4B7ls.js";
import { t as note } from "./note-BDUXzWsU.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-CveIY8wR.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-CVkwj8az.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-D2tRnk8_.js");
