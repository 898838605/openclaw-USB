...
import { n as collectConfiguredRuntimePluginIds, r as resolveConfiguredRuntimePluginInstallCandidate } from "./configured-runtime-plugin-installs-CEIebjtm.js";
...
async function runPluginsEnableCommand(id) {
	...
	const { enablePluginInConfig } = await import("./enable-Ci10296v.js");
	const { normalizePluginId } = await import("./config-state-C30PIrOG.js");
	const { buildPluginRegistrySnapshotReport } = await import("./status-CEHNGYdz.js");
	const { applySlotSelectionForPlugin, logSlotWarnings } = await import("./plugins-command-helpers-OYyVhbhC.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-D6F44euU.js");
...
async function runPluginsDisableCommand(id) {
	...
	const { normalizePluginId } = await import("./config-state-C30PIrOG.js");
	const { buildPluginRegistrySnapshotReport } = await import("./status-CEHNGYdz.js");
	const { setPluginEnabledInConfig } = await import("./plugins-config-DJErRrnR.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-D6F44euU.js");
	const snapshot = await readConfigFileSnapshot();
	const cfg = snapshot.sourceConfig ?? snapshot.config;
	const report = buildPluginRegistrySnapshotReport({ config: cfg });
...
async function runPluginsInstallAction(raw, opts) {
	await tracePluginLifecyclePhaseAsync("install command", async () => {
		const { runPluginInstallCommand } = await import("./plugins-install-command-C7nlwihn.js");
...
async function runPluginsRegistryCommand(opts) {
	const { inspectPluginRegistry, refreshPluginRegistry } = await import("./plugin-registry-B9zy26KS.js");
...
async function runPluginsDoctorCommand() {
	const { buildPluginCompatibilityNotices, buildPluginDiagnosticsReport, formatPluginCompatibilityNotice } = await import("./status-CEHNGYdz.js");
...
async function runPluginMarketplaceListCommand(source, opts) {
	const { listMarketplacePlugins } = await import("./marketplace-P-BtqABB.js");
	const { createPluginInstallLogger } = await import("./plugins-command-helpers-OYyVhbhC.js");
