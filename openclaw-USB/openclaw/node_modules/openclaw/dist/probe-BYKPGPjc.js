...
import { f as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-CYDoDi4S.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-C6599BF5.js");
