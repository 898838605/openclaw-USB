...
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-DUwbsKjv.js";
...
import { i as getChildLogger } from "./logger-ApTu_tEr.js";
import { a as shouldLogVerbose, r as logVerbose, s as warn, t as danger } from "./globals-BmUmhyAe.js";
...
import { n as mutateConfigFile } from "./mutate-DyuMRjr1.js";
import { u as fireAndForgetHook } from "./hook-runner-global-CKF4eCEZ.js";
import { t as createDedupeCache } from "./dedupe-Dz8bskmN.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-Ci62WSre.js";
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths-RbVDOqFp.js";
import { A as resolveSessionStoreEntry, t as loadSessionStore } from "./store-load-DjaY7SAt.js";
import { s as updateSessionStore } from "./store-CmwzJ9N6.js";
import { c as appendSessionTranscriptMessage, l as resolveAndPersistSessionFile, r as readLatestAssistantTextFromSessionTranscript } from "./transcript-BEv_N5f2.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-Pp-VxfGB.js";
import { C as findModelInCatalog } from "./model-selection-shared-CDpQv6TV.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-BKKLDOm5.js";
import { a as modelSupportsVision, r as loadModelCatalog } from "./model-catalog-Nx2O35da.js";
import { h as isInsideCode, m as findCodeRegions, u as stripReasoningTagsFromText } from "./assistant-visible-text-BG-87G2B.js";
import { n as sleepWithAbort, t as computeBackoff } from "./backoff-Db80NPS1.js";
import { i as toInternalMessageReceivedContext } from "./message-hook-mappers-7jVKerRx.js";
import { a as getReplyPayloadTtsSupplement, n as buildTtsSupplementMediaPayload } from "./reply-payload-DNKaYjcZ.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-UitMHHLq.js";
import { l as normalizeMessagePresentation } from "./payload-y0EkMuyx.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-DBJpi3xm.js";
import { s as formatReasoningMessage } from "./pi-embedded-utils-D4Sg9KBJ.js";
import { a as projectOutboundPayloadPlanForDelivery, t as createOutboundPayloadPlan } from "./payloads-BsXJf6bR.js";
import { A as selectLongerFinalText, D as resolveChannelStreamingPreviewToolProgress, S as resolveChannelStreamingBlockEnabled, a as createChannelProgressDraftGate, c as formatChannelProgressDraftText, d as isPotentialTruncatedFinal, f as mergeChannelProgressDraftLine, i as buildChannelProgressDraftLineForEntry, k as resolveTranscriptBackedChannelFinalText, o as formatChannelProgressDraftLine, s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName, y as resolveChannelProgressDraftMaxLines } from "./channel-streaming-OghHUGgH.js";
import { n as MediaFetchError } from "./fetch-Cb_2Qt_I.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-CIV-dQ8A.js";
import { t as resolveAckReaction } from "./identity-D7NWCFSq.js";
import { t as deriveDurableFinalDeliveryRequirements } from "./capabilities-D2W-z50h.js";
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, s as resolveChunkMode } from "./chunk-BY5zkw75.js";
import { n as createPreviewMessageReceipt } from "./live-CM5Ctqtt.js";
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-DBgfYxUW.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-DVfp8ntm.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-CxPGc_c_.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-w3ZxYBkU.js";
import { f as parsePluginBindingApprovalCustomId, i as buildPluginBindingResolvedText, m as resolvePluginConversationBindingApproval } from "./conversation-binding-CmMDQlSJ.js";
import { n as listChatCommands } from "./commands-registry-list-hzM0TkI-.js";
import { n as maybeResolveTextAlias, r as normalizeCommandBody } from "./commands-registry-normalize-kHzcuhlz.js";
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-QgNf4rX0.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes } from "./mentions-DZxlOMaP.js";
import { n as isAbortRequestText } from "./abort-primitives-CSIjZAQb.js";
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-B_rwZkLx.js";
import { t as isApprovalNotFoundError } from "./approval-errors-CsA9WUQT.js";
import "./error-runtime-Dvd9qNRG.js";
import "./runtime-env-3iVG5ApJ.js";
import "./string-coerce-runtime-PzdFg3e_.js";
import "./routing-CiZmgoKn.js";
import { t as getPluginCommandSpecs } from "./command-specs-B-5P366Q.js";
import { t as hasControlCommand } from "./command-detection-BQjcGMBC.js";
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope } from "./envelope-CqM7X9Yo.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-Bi7EPIkn.js";
import { i as shouldAckReaction, n as removeAckReactionAfterReply } from "./ack-reactions-CbKaBaa6.js";
import { n as resolveInboundMentionDecision, t as implicitMentionKindWhen } from "./mention-gating-B9KrkMgl.js";
import "./history-REm19vSg.js";
import { t as createChannelReplyPipeline } from "./reply-pipeline-CzSKhl9A.js";
import { t as evaluateSupplementalContextVisibility } from "./context-visibility-P-z6161c.js";
import { t as createChannelHistoryWindow } from "./history-window-Dq4Yg5af.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-CLqjYwCf.js";
import { a as readChannelAllowFromStore, d as upsertChannelPairingRequest } from "./pairing-store-CX-8tne7.js";
import { n as firstDefined } from "./allow-from-B2ELkgYN.js";
import "./channel-policy-5OUFC0mF.js";
import { c as defineStableChannelIngressIdentity, n as createChannelIngressResolver } from "./runtime-CUMKx3lX.js";
import "./reply-history-xwbltXk8.js";
import { m as parseExecApprovalCommandText } from "./exec-approval-reply-CHDfCPTH.js";
import "./approval-reply-runtime-DTDJPU_3.js";
import { t as resolveChannelContextVisibilityMode } from "./context-visibility-1L8k4aPI.js";
import { n as resolveNativeCommandsEnabled, r as resolveNativeSkillsEnabled, t as isNativeCommandsExplicitlyDisabled } from "./commands-Ch-YiPTF.js";
import "./config-mutation-zB3q8eUl.js";
import { n as resolveStoredModelOverride } from "./stored-model-override-KM_v-MUA.js";
import { n as isBtwRequestText } from "./btw-command-DMSU_v4W.js";
import { t as generateConversationLabel } from "./conversation-label-generator-BNNNUK0W.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-BoaU0QaF.js";
import "./reply-chunking-CRFnRQ5s.js";
import { d as runInboundReplyTurn } from "./inbound-reply-dispatch-CyXK3E-S.js";
import "./outbound-runtime-Dz2-CJ_b.js";
import "./runtime-config-snapshot-DPYwA1C8.js";
import "./model-session-runtime-nxXSTCp9.js";
import "./media-runtime-CMDtdPYL.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-X8DPnpjX.js";
import "./conversation-runtime-KF9ohPET.js";
import "./text-chunking-D3P3fj2E.js";
import "./agent-runtime-CfVr0uF5.js";
import { i as createInteractiveConversationBindingHelpers, r as dispatchPluginInteractiveHandler } from "./plugin-runtime-BE0fKF7g.js";
import "./security-runtime-CKlH5FER.js";
import "./agent-harness-runtime-BMrsaaM3.js";
import "./hook-runtime-D2j04VWN.js";
import "./markdown-table-runtime-Cu-04nx8.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-BCWWB7Gi.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-CKCwBFJu.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-C8N_meQ_.js";
import { n as formatModelsAvailableHeader } from "./commands-models-CJ3GghDD.js";
import "./command-auth-native-BRoobCu2.js";
import "./command-primitives-runtime-CtJjI4an.js";
import "./command-status-ChiHw-8M.js";
import "./command-detection-D9z-UZhD.js";
import "./command-surface-BVsieuVM.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-CbaaXoJ4.js";
import { a as DEFAULT_TIMING, i as DEFAULT_EMOJIS } from "./channel-feedback-xEKbEkil.js";
import { i as resolveUnmentionedGroupInboundPolicy, r as classifyChannelInboundEvent, s as shouldDebounceTextInbound } from "./channel-inbound-DHfXlvj5.js";
import { n as toLocationContext, t as formatLocationText } from "./location-DCLiUuvw.js";
import "./channel-ingress-runtime-DXFipvGj.js";
import { h as createMessageReceiveContext } from "./channel-message-A0qNE-jd.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-CdXvFu9A.js";
import "./session-store-runtime-CAZF8SRe.js";
import "./models-provider-runtime-BHdOOitV.js";
import "./skill-commands-runtime-9Pmy9X77.js";
import "./native-command-config-runtime-1wF2nnUV.js";
import { t as mergeTelegramAccountConfig } from "./account-config-C5aC0B1z.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-DJD04MYo.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-DHjJ-S7K.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-A6dKzQdR.js";
import { A as withResolvedTelegramForumFlag, B as resolveTelegramPrimaryMedia, C as resolveTelegramForumFlag, D as resolveTelegramStreamMode, E as resolveTelegramReplyId, F as getTelegramTextParts, G as normalizeDmAllowFromWithStore, H as resolveTelegramDmAllow, I as hasBotMention, K as resolveTelegramEffectiveDmPolicy, M as buildSenderName, N as expandTextLinks, O as resolveTelegramThreadSpec, P as extractTelegramLocation, R as normalizeForwardedContext, S as resolveTelegramDirectPeerId, T as resolveTelegramGroupAllowFromContext, U as isSenderAllowed, V as expandTelegramAllowFromWithAccessGroups, W as normalizeAllowFrom, _ as describeReplyTarget, a as renderTelegramHtmlText, d as buildTelegramGroupPeerId, f as buildTelegramInboundOriginTarget, g as buildTypingThreadParams, h as buildTelegramThreadParams, j as buildSenderLabel, k as shouldUseTelegramDmThreadSession, l as buildGroupLabel, m as buildTelegramRoutingTarget, n as markdownToTelegramChunks, p as buildTelegramParentPeer, u as buildTelegramGroupFrom, v as extractTelegramForumFlag, w as resolveTelegramForumThreadId, x as resolveTelegramCommandAuthorization, y as isTelegramCommandsAllowFromConfigured } from "./format-AZK6G0is.js";
import { t as resolveTelegramInlineButtons } from "./button-types-BG0nAHqD.js";
import { d as buildModelsKeyboard, g as resolveModelSelection, h as parseModelCallbackData, m as getModelsPageSize, o as buildTelegramModelsMenuButtons, p as calculateTotalPages, t as buildCommandsPaginationKeyboard } from "./command-ui-B4jtYl8U.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-CgGVkNsJ.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-1cMvG9O1.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-BImrIut2.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-DPuJk7Bw.js";
import { A as Bot, C as createTelegramClientFetch, E as resolveTelegramOutboundClientTimeoutFloorSeconds, M as sequentialize, O as withTelegramApiErrorLogging, S as asTelegramClientFetch, T as resolveTelegramClientTimeoutSeconds, a as editMessageTelegram, g as recordSentMessage, j as apiThrottler, k as getOrCreateAccountThrottler, w as resolveTelegramClientTimeoutMinimumSeconds, x as buildInlineKeyboard } from "./send-BbEfpYRk.js";
import { t as beginTelegramInboundEventDeliveryCorrelation } from "./inbound-event-delivery-Bje0fuO2.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-CiCNa5m4.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-DzKwsl_D.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-sjCsQP0p.js");
...
const registerTelegramHandlers = ({ cfg, accountId, bot, opts, telegramTransport, runtime, mediaMaxBytes, telegramCfg, allowFrom, groupAllowFrom, resolveGroupPolicy, resolveTelegramGroupConfig, shouldSkipUpdate, processMessage, logger, telegramDeps, resolveGroupActivation, resolveGroupRequireMention }) => {
	...
	const processInboundMessage = async (params) => {
		const { ctx, msg, chatId, isGroup, isForum, resolvedThreadId, dmThreadId, dmPolicy, storeAllowFrom, senderId, effectiveGroupAllow, effectiveDmAllow, groupConfig, topicConfig, sendOversizeWarning, oversizeLogMessage, promptContextMinTimestampMs } = params;
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	...
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-aTyPQ95N.js")).defaultTelegramBotDeps;
