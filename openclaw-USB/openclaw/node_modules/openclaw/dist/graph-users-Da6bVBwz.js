...
import { d as normalizeSecretInputString, s as hasConfiguredSecretInput, u as normalizeResolvedSecretInputString } from "./types.secrets-CJS3n8Im.js";
...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, c as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-BdjxtZd0.js";
...
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-BfUcpqyd.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-R75ezP7-.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-Ctd9P5Xg.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-DwMcpW5I.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-HS4tDelk.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
