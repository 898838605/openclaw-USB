...
import { s as hasConfiguredSecretInput } from "./types.secrets-CJS3n8Im.js";
...
import { a as createActionGate } from "./common-Co_iMEX5.js";
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-DBgfYxUW.js";
import "./string-coerce-runtime-PzdFg3e_.js";
import { n as describeAccountSnapshot } from "./account-helpers-B8hw5Y0t.js";
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-B_GhzhOy.js";
...
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-5OUFC0mF.js";
...
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-T0DeZAMI.js";
...
import "./account-resolution-BzNOuE3h.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-e9hGas1o.js";
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-C-oqS7jT.js";
import "./channel-status-NcWRkUVm.js";
import "./channel-config-primitives-BfBpCNgW.js";
...
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-DRWezOGs.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-D4qux2eC.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, m as isRecord, n as inspectFeishuCredentials, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-bC_wYGgh.js";
import { n as createFeishuSendReceipt } from "./send-result-2-C7a9Iv.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-D_Rt9f7r.js";
import { t as messageActionTargetAliases } from "./security-audit-COisP4Er.js";
import { s as resolveFeishuGroupToolPolicy } from "./policy-BiR6E1C0.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-CEDI_rLj.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-D0Ye7qAF.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-CE6pkeTA.js";
...
async function runScanToCreate(prompter, domain) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-CE_m_jVl.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-CE_m_jVl.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-CAwmT8pP.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BnkXQAef.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-B5v2Qwd7.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-DVLh_NtK.js");
