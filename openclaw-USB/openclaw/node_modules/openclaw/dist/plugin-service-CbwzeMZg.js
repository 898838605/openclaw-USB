...
import { _ as readStringParam, c as imageResultFromFile, l as jsonResult } from "./common-Co_iMEX5.js";
...
import { i as wrapExternalContent } from "./external-content-Bh9UoUbE.js";
import "./string-coerce-runtime-PzdFg3e_.js";
import { n as startLazyPluginServiceModule } from "./plugin-runtime-BE0fKF7g.js";
import { o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-D3UQQKJS.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError } from "./nodes.helpers-DizcZeDL.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-Dz1_1VNp.js";
import { n as withTimeout } from "./sdk-security-runtime-D3USIm2N.js";
import { R as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-C1lGOz_w.js";
import { i as resolveProfile, n as resolveBrowserConfig, s as DEFAULT_UPLOAD_DIR } from "./config-C9_kCE1I.js";
import "./sdk-setup-tools-BEvnuHEB.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-BFUbzVV4.js";
import { c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as isPersistentBrowserProfileMutation, l as browserAct, n as persistBrowserProxyFiles, o as resolveRequestedBrowserProfile, p as browserScreenshotAction, s as browserConsoleMessages, t as applyBrowserProxyPaths, u as browserArmDialog } from "./browser-runtime-jYBERpcF.js";
import { r as getBrowserProfileCapabilities } from "./target-id-CRprNw4w.js";
import { r as createBrowserRouteDispatcher, t as startBrowserControlServiceFromConfig } from "./control-service-FDQHhS-b.js";
import { n as createBrowserControlContext } from "./plugin-enabled-CsYpUzvd.js";
import "./core-api-_msmiJAN.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-C-WsjchC.js"),
