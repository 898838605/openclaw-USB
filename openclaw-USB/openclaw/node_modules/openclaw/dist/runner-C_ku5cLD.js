...
import { i as runExec } from "./exec-DxBD2Ybt.js";
...
import { i as readRemoteMediaBuffer, n as MediaFetchError } from "./fetch-Cb_2Qt_I.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-CIV-dQ8A.js";
import { n as isMinimaxVlmProvider, t as isMinimaxVlmModel } from "./minimax-vlm-BjwG15R3.js";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-4cQ_JYCX.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-5vRBDqE0.js";
import { t as providerSupportsCapability } from "./provider-supports-CH-j-IAE.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-CisQt5tP.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-D5-twe2h.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-DXDB2emR.js";
import { t as buildRandomTempFilePath } from "./temp-download-CL_tKb5-.js";
import "./temp-path-BMNkWS2N.js";
import { a as runCliEntry, c as extractGeminiResponse, d as isMediaUnderstandingSkipError, l as fileExists, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, u as MediaUnderstandingSkipError } from "./runner.entries-B_d2KLaK.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-CXR_Da8S.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-B2GLD33r.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-5DzlOm4z.js");
