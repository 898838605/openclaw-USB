...
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-jTiXT_tb.js";
import { _ as readStringParam, a as createActionGate, n as ToolAuthorizationError, p as readNumberParam } from "./common-Co_iMEX5.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-DBgfYxUW.js";
import "./string-coerce-runtime-PzdFg3e_.js";
import { n as describeAccountSnapshot } from "./account-helpers-B8hw5Y0t.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-DhuTXLoE.js";
...
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-5OUFC0mF.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-DQayqUIf.js";
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-ByS2Vap-.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-4v_2GDLD.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-B4Isf5wU.js";
...
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-JgWiqBvK.js";
import { n as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-Cd-vlOW7.js";
import "./approval-native-runtime-B2b7jU01.js";
import "./outbound-runtime-Dz2-CJ_b.js";
import "./conversation-runtime-KF9ohPET.js";
import { t as chunkTextForOutbound } from "./text-chunking-D3P3fj2E.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-e9hGas1o.js";
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-C-oqS7jT.js";
import "./channel-status-NcWRkUVm.js";
import "./channel-actions-C-moiiWs.js";
...
import { t as extractToolSend } from "./tool-send-C5qXqG2y.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-Ckvj5sL_.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-Dvyh3y8I.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-D-TUs9eH.js";
import { a as resolveMatrixAccountConfig } from "./account-config-JKkSSbtJ.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-S8bsQeEp.js";
import { n as normalizeMatrixUserId } from "./allowlist-lnCrAKe0.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-vnGyAyLk.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-YfbdHqYN.js";
import { t as formatMatrixErrorMessage } from "./errors-DOzOicEh.js";
import { n as matrixConfigAdapter, t as MatrixChannelConfigSchema } from "./config-schema-Cvc9fME3.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-HRSd5pTh.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-D6ppjzMl.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-BQ2JSD6o.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-C5rkuqLV.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-BIDA_t4J.js";
...
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-CE2g46oQ.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-Dv0Jp-Jf.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-De-hNUlO.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-CKUXScqC.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-C1t9R3rI.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixDoctor = {
	...
	runConfigSequence: async ({ cfg, env, shouldRepair }) => await (await import("./doctor-CEbijpjc.js")).runMatrixDoctorSequence({
		cfg,
		env,
		shouldRepair
	}),
	cleanStaleConfig: async ({ cfg }) => await (await import("./doctor-CEbijpjc.js")).cleanStaleMatrixPluginConfig(cfg)
};
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-B-J6ckdV.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
