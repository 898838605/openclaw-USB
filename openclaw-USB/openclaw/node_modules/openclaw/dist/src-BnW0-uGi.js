...
import { n as require_ecdsa_sig_formatter, t as require_jws } from "./jws-BLGbctrs.js";
import { n as require_extend, t as require_package$1 } from "./package-RMNd65r4.js";
import { t as require_json_bigint } from "./json-bigint-DrgqwbMk.js";
 ...
 /**
		...
		*/
		static async #getProxyAgent() {
			this.#proxyAgent ||= (await import("./dist-CtcXdMZX.js").then((m) => /* @__PURE__ */ __toESM(m.default))).HttpsProxyAgent;
			return this.#proxyAgent;
		}
		static async #getFetch() {
			const hasWindow = typeof window !== "undefined" && !!window;
			this.#fetch ||= hasWindow ? window.fetch : (await import("./src-C2nLwZpg.js")).default;
			return this.#fetch;
		}
		/**
		* Merges headers.
