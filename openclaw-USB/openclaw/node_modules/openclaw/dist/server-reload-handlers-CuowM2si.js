...
import { n as loadInstalledPluginIndexInstallRecordsSync, t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-DR3h__QQ.js";
...
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-x8yr89ni.js";
import { o as resetModelCatalogCache } from "./model-catalog-Nx2O35da.js";
import { c as listActiveEmbeddedRunSessionKeys, o as getActiveEmbeddedRunCount, s as listActiveEmbeddedRunSessionIds } from "./run-state-CpenSgg5.js";
...
import { i as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-kBY5eAjg.js";
...
import { r as resetDirectoryCache } from "./target-resolver-B6MjbiBt.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-C-PxaRXk.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-Dd7u0hAX.js";
import { _ as resolveHooksConfig } from "./hooks-DD_eQtSi.js";
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-CQ6F_jWv.js";
import { i as diffConfigPaths, n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-DspHeq2w.js";
...
import { t as buildGatewayCronService } from "./server-cron-CKQu4czX.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-DFItqHpK.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-D2oSGzVT.js";
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-DgQ2PA51.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-CIaYKP4z.js"), import("./gmail-watcher-lifecycle-BuaOJxh2.js")]);
