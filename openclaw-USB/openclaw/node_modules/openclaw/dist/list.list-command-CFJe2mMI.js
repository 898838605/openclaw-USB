...
import { m as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-iimloLsx.js";
...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-CljpontN.js";
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-Bs7SHB8Y.js";
import { s as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-17ICsBr_.js";
...
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-CiLEGnXI.js";
import "./model-selection-BKKLDOm5.js";
import { t as resolveEnvApiKey } from "./model-auth-env-CviUIkdl.js";
import { r as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-DAhI9GRn.js";
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-DOcJ8K8t.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-Ancb10w3.js";
import { n as loadModelsConfigWithSource } from "./load-config-PUkEPXIm.js";
import { n as formatErrorWithStack } from "./list.errors-mrGLsFYq.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-D8j8hhZo.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-CMW0GUcr.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-D5KHtgOS.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-XWRg4jwO.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-CgFxQLFC.js"),
		import("./agent-scope-DSPBbrtb.js"),
		import("./workspace-D50ElaxT.js")
	]);
