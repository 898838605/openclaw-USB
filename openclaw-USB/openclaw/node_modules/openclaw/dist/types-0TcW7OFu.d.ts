import { i as OpenClawConfig } from "./types.openclaw-BY90lWqT.js";
import { t as ChannelId } from "./channel-id.types-COdJCz0S.js";
import { i as resolveHumanDelayConfig, r as resolveEffectiveMessagesConfig } from "./identity-CM4Vt-Ph.js";
import { $ as RecordSessionMetaFromInbound$1, Q as ReadSessionUpdatedAt$1, et as UpdateLastRoute$1, o as PluginRuntimeCore } from "./types-core-CQo_9HXz.js";
import { m as resolveStorePath } from "./store-CjQGTh_e.js";
import { _ as chunkTextWithMode, g as chunkText, h as chunkMarkdownTextWithMode, m as chunkMarkdownText, n as ChannelOutboundAdapter, p as chunkByNewline, v as resolveChunkMode, y as resolveTextChunkLimit } from "./outbound.types-Djrbiefw.js";
import { n as ReplyDispatcher } from "./reply-dispatcher.types-DbZsaVJV.js";
import { s as CommandNormalizeOptions, u as ShouldHandleTextCommandsParams } from "./commands-registry.types-TZ8ld9AU.js";
import { i as MatchesMentionWithExplicit$1, r as MatchesMentionPatterns$1, t as BuildMentionRegexes$1 } from "./mentions.types-ClLgONT-.js";
import { n as RecordInboundSession$1 } from "./session.types-C71x3tm7.js";
import { c as SessionBindingRecord } from "./session-binding.types-VxdtYQ5G.js";
import { t as hasControlCommand } from "./command-detection-Dfi12sh6.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-DYwjbdIq.js";
import { t as convertMarkdownTables } from "./tables-B7vW8TY7.js";
import { n as DispatchReplyFromConfig } from "./dispatch-from-config.types-BYUX774J.js";
import { t as finalizeInboundContext } from "./inbound-context-DUmD8e0M.js";
import { a as resolveEnvelopeFormatOptions, n as formatAgentEnvelope, r as formatInboundEnvelope } from "./envelope-D8kJO6SJ.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-DFBpV0RK.js";
import { n as ReadChannelAllowFromStoreForAccount, r as UpsertChannelPairingRequestForAccount } from "./pairing-store.types-04FPM3U1.js";
import { t as buildPairingReply } from "./pairing-messages-DPuCo93v.js";
import { p as saveMediaBuffer } from "./store-CznChwV3.js";
import { d as readRemoteMediaBuffer, f as saveRemoteMedia, p as saveResponseMedia, u as fetchRemoteMedia } from "./fetch-DXu_7Lo8.js";
import { n as getChannelActivity, r as recordChannelActivity } from "./channel-activity-C5XSdZln.js";
import { f as implicitMentionKindWhen, p as resolveInboundMentionDecision } from "./mention-gating-BF23e3zY.js";
import { a as createAckReactionHandle, c as shouldAckReaction, o as removeAckReactionAfterReply, s as removeAckReactionHandleAfterReply } from "./ack-reactions-CeddR899.js";
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-BmCi9QFD.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-CdH88FUP.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-5UqnuDbK.js";
import { o as createReplyDispatcherWithTyping, t as DispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher.types-i-3rec6r.js";
import { r as buildChannelInboundEventContext } from "./context-Dbp8wCqj.js";
import { a as runPreparedChannelTurn, i as runChannelTurn, o as runResolvedChannelTurn, t as dispatchAssembledChannelTurn } from "./kernel-CNkk_fVx.js";
