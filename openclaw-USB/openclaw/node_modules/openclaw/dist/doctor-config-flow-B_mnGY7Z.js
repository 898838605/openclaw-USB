...
import { i as LEGACY_SECRETREF_ENV_MARKER_PREFIX, p as parseLegacySecretRefEnvMarker } from "./types.secrets-CJS3n8Im.js";
...
import { r as normalizeChatChannelId } from "./ids-CRqUrRLW.js";
import { i as setPathExistingStrict } from "./path-utils-DN7Dilmr.js";
import { n as discoverConfigSecretTargets } from "./target-registry-C_zcP3-N.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-DnGGugrj.js";
import { n as formatConfigIssueLines } from "./issue-format-BTP4B7ls.js";
import { r as normalizeTalkSection } from "./talk-EgZSwsfJ.js";
import { n as collectConfiguredModelRefs } from "./model-refs-Byh1O5l0.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-DLmuIJtf.js";
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-DowL9sGd.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-CHoxAZCG.js";
import { n as getLoadedChannelPlugin } from "./registry-OCFvwkK7.js";
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, s as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-B6Kp5Mg9.js";
import { i as listRouteBindings } from "./bindings-nkeAxHgE.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-B06vbGWS.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-B8ydo8_4.js";
import { t as note } from "./note-BDUXzWsU.js";
import { t as asObjectRecord } from "./object-ayN0o9JX.js";
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-CveIY8wR.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-Cr5NCycG.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-C5kPXgiL.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-Dj7SpXRN.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-D51kHVmA.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-Dytzfu9x.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-B3KDmVKv.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-DCY-k9eV.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-D5ViwxbX.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-BHE2jVuL.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-B0zAUkWg.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-CFWr6MWl.js");
		emitDoctorNotes({
			note,
