...
const deliverInboundReplyWithMessageSendContext = async (...args) => {
	return await (await import("./kernel-CO1f0BP9.js")).deliverInboundReplyWithMessageSendContext(...args);
};
...
async function withDurableMessageSendContext(params, run) {
	return await (await import("./runtime-D1yJLQPy.js")).withDurableMessageSendContext(params, run);
}
