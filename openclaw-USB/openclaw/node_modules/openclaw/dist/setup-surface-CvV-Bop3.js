...
import { O as promptAccountId, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-T0DeZAMI.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-Dvj84JJf.js";
...
import { r as resolveMatrixEnvAuthReadiness } from "./env-auth-D43OoTwd.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-S8bsQeEp.js";
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-C5rkuqLV.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-BzATY3VI.js";
import { n as updateMatrixAccountConfig } from "./config-update-DOmj7ReP.js";
import { n as validateMatrixHomeserverUrl, t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-cxE9hTK9.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "./deps-DFGTtt-O.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-By9-1lY5.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = setMatrixGroupPolicy(next, accessConfig.policy, params.accountId);
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-uFamat55.js");
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-CFqcWPSt.js");
