...
import { t as enablePluginInConfig } from "./enable-CzpxjsaG.js";
...
import { a as createLazyRuntimeSurface } from "./lazy-runtime-jTiXT_tb.js";
...
import "./model-auth-DOcJ8K8t.js";
import { a as normalizeSecretInputModeInput } from "./provider-auth-input-CmAvy5EY.js";
import { r as resolveManifestProviderAuthChoice, t as resolveManifestDeprecatedProviderAuthChoice } from "./provider-auth-choices-BOUzYbm9.js";
import { n as isDeprecatedAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-Ca4oyIwh.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-B12bMfej.js";
import { c as parseNonInteractiveCustomApiFlags, d as resolveCustomProviderId, n as applyCustomApiConfig, t as CustomApiError } from "./onboard-custom-config-DTzNfAHI.js";
import { t as createNonInteractiveLoggingPrompter } from "./non-interactive-prompter-CQ0UD7Vw.js";
import { t as normalizeApiKeyTokenProviderAuthChoice } from "./auth-choice.apply.api-providers-BItRw-Er.js";
import { n as ensureCodexRuntimePluginForModelSelection, t as CODEX_RUNTIME_PLUGIN_ID } from "./codex-runtime-plugin-install-5uvo2ZyT.js";
...
async function applyNonInteractivePluginProviderChoice(params) {
	...
	if (codexInstall.installed) {
		const { offerPostInstallMigrations } = await import("./setup.post-install-migration-BO9AV71_.js");
