...
import "./session-binding-runtime-CSgZAhyQ.js";
import { a as resolveMatrixAccountConfig } from "./account-config-JKkSSbtJ.js";
import { a as extractMatrixReactionAnnotation } from "./reaction-common-bVnvlgHT.js";
import { a as unregisterMatrixApprovalReactionTarget, i as resolveMatrixApprovalReactionTargetWithPersistence } from "./approval-reactions-4IPNdXwJ.js";
import { i as resolveMatrixThreadRouting, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-CC1DkRpl.js";
...
function loadApprovalReactionAuth() {
	approvalReactionAuthPromise ??= import("./approval-reaction-auth-DAQrVUey.js");
	return approvalReactionAuthPromise;
}
function loadExecApprovalResolver() {
	execApprovalResolverPromise ??= import("./exec-approval-resolver-CCVFmlrp.js");
