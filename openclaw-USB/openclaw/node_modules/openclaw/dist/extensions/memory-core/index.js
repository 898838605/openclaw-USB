...
import { l as jsonResult } from "../../common-Co_iMEX5.js";
import "../../pi-settings-CpBzy06U.js";
...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-CoTfejT3.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-6-2RdUCN.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-DIL3ZJzA.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-D1IzR5se.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-BO1z5z2Q.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-DjxZ-Jzm.js");
