...
import { C as hasSessionAutoModelFallbackProvenance, _ as resolveSessionAgentId, i as markAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, p as resolveAutoFallbackPrimaryProbe, r as hasConfiguredModelFallbacks, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-Cf7T6Ju7.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-CQewiu8n.js";
import { r as resolveAgentConfig } from "./agent-scope-config-DUwbsKjv.js";
...
import { a as isDiagnosticsEnabled, i as emitTrustedDiagnosticEvent, m as freezeDiagnosticTraceContext, u as createChildDiagnosticTraceContext } from "./diagnostic-events-CyaAsfPZ.js";
...
import { _ as resolveResponseUsageMode, g as normalizeVerboseLevel } from "./thinking-CvQif4jm.js";
import { n as parseNonNegativeByteSize } from "./zod-schema-B8qk5q8o.js";
import "./config-CR6nsEzH.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-JqYBZqnL.js";
import { c as resolveContextConfigProviderForRuntime, l as resolveOpenAIRuntimeProviderForPi } from "./openai-codex-routing-17ICsBr_.js";
import { t as resolveAgentHarnessPolicy } from "./policy-DYe4G92j.js";
import { x as resolveMemoryFlushPlan } from "./memory-state-CVl5QzvG.js";
import { i as emitAgentEvent, l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-DVSiKwui.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-RbVDOqFp.js";
import { t as loadSessionStore } from "./store-load-DjaY7SAt.js";
import { c as updateSessionStoreEntry, g as resolveGroupSessionKey, s as updateSessionStore } from "./store-CmwzJ9N6.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-CvORIrpN.js";
...
import { l as resolvePersistedOverrideModelRef } from "./model-selection-BKKLDOm5.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-BxvTRKnH.js";
import { a as enqueueSystemEvent } from "./system-events-Coh4mKQt.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-DEIGMzB3.js";
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-BG-87G2B.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-BNhO6xXL.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-W8f_0sUm.js";
import { f as replyRunRegistry, i as createReplyOperation, t as ReplyRunAlreadyActiveError } from "./reply-run-registry-CcD5OkAB.js";
import { d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary } from "./runs-CfIOZroM.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripLeadingSilentToken } from "./tokens-BlOFOAQM.js";
...
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, r as deriveSessionTotalTokens, t as deriveContextPromptTokens } from "./usage-C0ofRzYq.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-qtbgMQw3.js";
import { a as resolveContextTokensForModel } from "./context-BOq-RKZX.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-CA9pmIOM.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-CQS64N4-.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-BPccW2Ar.js";
import { c as markReplyPayloadForSourceSuppressionDelivery, i as getReplyPayloadMetadata, l as setReplyPayloadMetadata, r as copyReplyPayloadMetadata, t as appendReplyMediaFailureWarning } from "./reply-payload-DNKaYjcZ.js";
...
import { $ as readPostCompactionContext } from "./selection-Cr-9-UpD.js";
import { u as stripHeartbeatToken } from "./heartbeat-BCpYGBga.js";
import { a as generateSecureUuid } from "./secure-random-CNLiQP3k.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-OP6llAL2.js";
import "./pi-embedded-helpers-BceuaEk2.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-Nyqt_31v.js";
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-Da1M4x-G.js";
import { u as resolveModelAuthMode } from "./model-auth-DOcJ8K8t.js";
import { u as parseReplyDirectives } from "./payloads-BsXJf6bR.js";
import { o as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-DPQE5cWR.js";
import { o as estimateMessagesTokens } from "./preemptive-compaction-Cw1bzYz-.js";
import { c as completeFollowupRunLifecycle, l as isFollowupRunAborted, o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-qrjrdX1U.js";
import { i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-C3fqfDNk.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-D4OyVBKb.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-lrfRzxAL.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-W4EDpsmT.js";
import { c as resolveCliRuntimeExecutionProvider, o as listLegacyRuntimeModelProviderAliases, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-B6Kp5Mg9.js";
import "./sandbox-BWb_xyE6.js";
import { n as resolveSendPolicy } from "./send-policy-BraRzZ2F.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-DPHCcHNN.js";
...
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-DFVsSnQY.js";
import { r as enqueueCommitmentExtraction } from "./runtime-S1zX_mM1.js";
import { c as resolveEffectiveBlockStreamingConfig } from "./agent-turn-attachments-2gx0wYAA.js";
import { a as resolveSilentReplyPolicy, i as resolveCurrentTurnImages, r as resolveActiveRunQueueAction, t as createTypingSignaler } from "./typing-mode-D44I4YRQ.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-CWLbYkOu.js";
import { c as setCliSessionId, r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-CszlfVr5.js";
import { t as runCliAgent } from "./cli-runner-jPUQ9KeD.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-UDtUcDJa.js";
import { t as formatProviderModelRef } from "./model-runtime-BNrQvSw-.js";
import "./fallback-notice-state-DmHHHGex.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-DV5v2jAz.js";
import { n as HEARTBEAT_EXTERNAL_RUN_FAILURE_TEXT, t as GENERIC_EXTERNAL_RUN_FAILURE_TEXT } from "./agent-runner-failure-copy-oK2Np1Cq.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-DHuLEeNC.js";
import { n as incrementCompactionCount } from "./session-updates-SntdPaSK.js";
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-r3d5ABvM.js"));
...
function joinCommitmentAssistantText(payloads) {
	return payloads.filter((payload) => !payload.isError && !payload.isReasoning && !payload.isCompactionNotice && !payload.isFallbackNotice).map((payload) => payload.text?.trim()).filter((text) => Boolean(text)).join("\n").trim();
}
...
async function runReplyAgent(params) {
	...
	try {
		...
		const hasReplyPayloadBeyondFallbackNotice = replyPayloads.some((payload) => !payload.isFallbackNotice);
		...
		const hasReminderCommitment = replyPayloads.some((payload) => !payload.isError && !payload.isFallbackNotice && typeof payload.text === "string" && hasUnbackedReminderCommitment(payload.text));
