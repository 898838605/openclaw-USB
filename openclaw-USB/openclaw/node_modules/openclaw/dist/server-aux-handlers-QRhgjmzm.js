...
import { m as resolveSecretInputRef } from "./types.secrets-CJS3n8Im.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-iimloLsx.js";
import { i as setPathExistingStrict, n as getPath } from "./path-utils-DN7Dilmr.js";
import { r as discoverConfigSecretTargetsByIds } from "./target-registry-C_zcP3-N.js";
import { a as resolveSecretRefValue } from "./resolve-Be4XLgF0.js";
...
import { n as channelRouteDedupeKey } from "./channel-route-cS6L3bdG.js";
import { n as getLoadedChannelPlugin } from "./registry-OCFvwkK7.js";
import { t as resolveChannelApprovalAdapter } from "./plugins-Cs-ACH2d.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-LSbIIqPW.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-BqMmeDlh.js";
import { a as getActiveSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeEnv } from "./runtime-state-B7rk2N8g.js";
import { t as assertExpectedResolvedSecretValue } from "./secret-value-C51HcvWj.js";
import { n as collectCommandSecretAssignmentsFromSnapshot, t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-IoFV7DdB.js";
import { r as createResolverContext } from "./runtime-shared-PBt2t5gt.js";
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-DQvsDcVT.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-CyAzpa0A.js";
import { d as formatExecApprovalExpiresIn } from "./exec-approval-reply-CHDfCPTH.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-DqMr5dg1.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-lQ1keVrA.js";
import { l as roleScopesAllow } from "./pairing-token-BpYpireV.js";
import { c as listDevicePairing, o as hasEffectivePairedDeviceRole } from "./device-pairing-D6nRUZtI.js";
import { i as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-DspHeq2w.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-CeqbP962.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-Bmvohd-X.js";
import "./server-aux-methods-BprXVd3m.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-DiiL58WC.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-DV5soCrB.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-ul2XU3pX.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-Bj8pmq_I.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
