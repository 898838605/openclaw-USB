...
import { o as coerceSecretRef, u as normalizeResolvedSecretInputString } from "./types.secrets-CJS3n8Im.js";
...
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-BdjxtZd0.js";
import "./ssrf-runtime-epFjLgMv.js";
import "./retry-runtime-BPtuFGiP.js";
import "./secret-input-runtime-DsCE9c_o.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-D-TUs9eH.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-CWPJxIIv.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-JKkSSbtJ.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-D43OoTwd.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-BzATY3VI.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-cxE9hTK9.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-D91vEj_T.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-Cnhx8bD5.js"), import("./logging-DkwmUf1I.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-rFiK1lpG.js").then((credentialsReadModule) => ({
