...
import { c as isSecretRef } from "./types.secrets-CJS3n8Im.js";
import { r as normalizeProviderId } from "./provider-id-Cz7K6wgK.js";
import { _ as resolveSessionAgentId } from "./agent-scope-Cf7T6Ju7.js";
...
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-DUwbsKjv.js";
import { c as measureDiagnosticsTimelineSpanSync, s as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-BxWkpxUl.js";
...
import { a as logWarn, t as logDebug } from "./logger-BGaqbYrv.js";
import "./auth-Duxztt3o.js";
import { n as resolveGatewayAuth, t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-BSzZWN7G.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-DnGGugrj.js";
import "./archive-BIRRxQjC.js";
...
import { t as applyMergePatch } from "./merge-patch-B1KO8sev.js";
import { r as DEFAULT_PROVIDER } from "./defaults-CWlUbhpa.js";
import { f as normalizeReasoningLevel, p as normalizeThinkLevel } from "./thinking-CvQif4jm.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-EgZSwsfJ.js";
import { h as resolveRuntimeConfigCacheKey } from "./runtime-snapshot-BCdniHcd.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-CljpontN.js";
import { t as validateJsonSchemaValue } from "./schema-validator-wgurAMJR.js";
import { i as replaceConfigFile, r as mutateConfigFileWithRetry } from "./mutate-DyuMRjr1.js";
import "./config-CR6nsEzH.js";
import { n as isRestartEnabled } from "./commands.flags-CYCjqSrD.js";
import { a as publicKeyRawBase64UrlFromPem, r as loadOrCreateDeviceIdentity } from "./device-identity-B1aG7MwP.js";
...
import { f as scheduleGatewaySigusr1Restart } from "./restart-x8yr89ni.js";
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-VaJeTVln.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-q8Kl1Dsn.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-CtdL1LKF.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-uzNnbVJ6.js";
import { C as createPluginGatewayMethodDescriptors, S as createGatewayMethodRegistry, v as patchPluginSessionExtension, x as createGatewayMethodDescriptorsFromHandlers } from "./loader-CxUWY2_6.js";
import { a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-nSi6iKFR.js";
import { i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-Ci62WSre.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-DVSiKwui.js";
import { t as isPluginJsonValue } from "./host-hook-json-CgIPvDoo.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-BIlePcj4.js";
import { a as resolveSessionStoreKey, i as resolveSessionStoreAgentId, o as resolveStoredSessionKeyForAgentStore, r as canonicalizeSpawnedByForAgent, s as resolveStoredSessionOwnerAgentId, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-DTxOYXKu.js";
import { h as stringifyRouteThreadId } from "./channel-route-cS6L3bdG.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-BuB7h14N.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-RbVDOqFp.js";
import { t as loadSessionStore } from "./store-load-DjaY7SAt.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-OCFvwkK7.js";
import { s as updateSessionStore } from "./store-CmwzJ9N6.js";
import "./plugins-Cs-ACH2d.js";
import { n as mergeSessionEntry } from "./types-CvORIrpN.js";
import { t as listConfiguredSessionStoreAgentIds } from "./targets-DGxp4nvt.js";
import { c as resolveSessionLifecycleTimestamps, i as serializeSessionCleanupResult, l as resolveMainSessionKeyFromConfig, r as runSessionsCleanup, t as purgeAgentSessionStoreEntries, u as extractDeliveryInfo } from "./sessions-BDnaolrd.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-CX-zoWBz.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-DaFjr7Mb.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-DQEvnLxe.js";
import { d as resolvePersistedAuthProfileOwnerAgentDir, i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-BYnn-xRZ.js";
import { f as parseConfiguredModelVisibilityEntries } from "./model-selection-shared-CDpQv6TV.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-CH0hjbpb.js";
import { t as resolveAgentTimeoutMs } from "./timeout-Dkhxn08A.js";
import { c as setHeartbeatsEnabled } from "./heartbeat-wake-CNeM5uoI.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-Coh4mKQt.js";
import { d as listTaskRecords, s as getTaskById } from "./task-registry-CFbnUDXn.js";
import { t as extractToolPayload } from "./tool-payload-Cef_jmYn.js";
import { a as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-tc_il70a.js";
import "./runtime-internal-Bxu9OuMJ.js";
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId, t as cancelDetachedTaskRunById } from "./detached-task-runtime-BgXQqjG6.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-rrKtgnj8.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-CpenSgg5.js";
import { _ as waitForEmbeddedPiRunEnd, n as abortEmbeddedPiRun, o as isEmbeddedPiRunActive } from "./runs-CfIOZroM.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-D_3ZT9EK.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-qtbgMQw3.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-CD5wJvRg.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-Bn8I2kb0.js";
import { o as getGatewayModelPricingHealth } from "./model-pricing-cache-state-BMum6iON.js";
...
import { n as detectRespawnSupervisor, t as SUPERVISOR_HINT_ENV_VARS } from "./supervisor-markers-BIyrTO_2.js";
import { c as resolveRestartSentinelPath, d as writeRestartSentinel, r as formatDoctorNonInteractiveHint } from "./restart-sentinel-BdX6w4bx.js";
import { l as getTotalQueueSize } from "./command-queue-CQS64N4-.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-DNQ4EXit.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-Di-EaxZa.js";
import { d as normalizeCronJobPatch, l as normalizeCronJobCreate, r as triggerSessionPatchHook } from "./openclaw-tools-wLbjLILX.js";
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-Bana6VmY.js";
import { s as resolveTrustedGroupId } from "./pi-tools.policy-DT-lAngt.js";
import { i as resolveSandboxConfigForAgent } from "./config-Dw9S3RVy.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-uSSc1OHx.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-DiLP25fi.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-DNgRLjQy.js";
import { a as isTimeoutError } from "./failover-error-Dds-8GA6.js";
import "./auth-profiles-C6JtuKOs.js";
import { n as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-DaSFqNF7.js";
import { n as listProfilesForProvider } from "./profile-list-CdhQb6vz.js";
import { i as removeProviderAuthProfilesWithLock } from "./profiles-DdWlNiEB.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-ZXNsSnoe.js";
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-BsXJf6bR.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-BqMmeDlh.js";
import { a as getActiveSecretsRuntimeSnapshot } from "./runtime-state-B7rk2N8g.js";
import { i as resolveIngressWorkspaceOverrideForSpawnedRun, r as normalizeSpawnedRunMetadata } from "./spawn-requester-origin-C_PTy4XI.js";
import { a as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-BAqu15pO.js";
import { i as parseAbsoluteTimeMs } from "./stagger-Defxe--T.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-CIV-dQ8A.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-CrcMoxGg.js";
import { a as clearSessionQueues } from "./queue-qrjrdX1U.js";
import { n as resolveAgentIdentity } from "./identity-D7NWCFSq.js";
import { t as buildOutboundSessionContext } from "./session-context-BEwZIs-6.js";
import { i as resolveReplyToMode } from "./reply-threading-D4OyVBKb.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-D4FQSC03.js";
import { r as resolveOutboundChannelPlugin } from "./channel-resolution-CwquH45s.js";
import { t as sendDurableMessageBatch } from "./send-ld3lzjwT.js";
import "./runtime-CfZm3jhA.js";
import { n as normalizePollInput } from "./polls-CI20ea0C.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-CuSrA8o7.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-DrdxqwF3.js";
import { i as validateTargetProviderPrefix, r as resolveTargetPrefixedChannel } from "./targets-session-BzsEQ1X9.js";
import { r as resolveOutboundTarget } from "./targets-8XIZ8NWH.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-C4sViWRs.js";
import { o as dispatchChannelMessageAction } from "./message-action-runner-Bs3VChcx.js";
import "./target-resolver-B6MjbiBt.js";
import { n as resolveOutboundSessionRoute, t as ensureOutboundSessionEntry } from "./outbound-session-DQqGZ-f9.js";
import { C as setTtsEnabled, E as setTtsProvider, O as synthesizeSpeech, T as setTtsPersona, _ as resolveTtsConfig, f as listTtsPersonas, g as resolveTtsAutoMode, h as resolveExplicitTtsOverrides, i as getResolvedSpeechProviderConfig, k as textToSpeech, l as isTtsEnabled, o as getTtsPersona, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsPrefsPath, y as resolveTtsProviderOrder } from "./tts-runtime-BVVdE3da.js";
import "./tts-BjNB0m2z.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-WZoAbmov.js";
import "./skills-BVKiIfvH.js";
import { n as resolveSendPolicy } from "./send-policy-BraRzZ2F.js";
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry-DZMCccqQ.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-hzM0TkI-.js";
import "./commands-registry-QgNf4rX0.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-C-PxaRXk.js";
import { a as resolveAgentRunExpiresAtMs, i as registerChatAbortController, n as abortChatRunsForProvider, o as updateChatRunProvider, t as abortChatRunById } from "./chat-abort-B4G2VoHz.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-ZvcAANxz.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-Daahz5Xn.js";
import { n as compactEmbeddedPiSession } from "./pi-embedded-ydXicp1O.js";
import "./browser-maintenance-CWSUSD7G.js";
import { c as performGatewaySessionReset } from "./session-reset-service-CYYp9D9R.js";
import { t as getPluginCommandSpecs } from "./command-specs-B-5P366Q.js";
import { r as listPluginCommands } from "./commands-BdI3fczN.js";
import { t as getChannelActivity } from "./channel-activity-CGCL75oJ.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BLv_2Lne.js";
import { t as WizardCancelledError } from "./prompts-BUOd-xVH.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-Z5f3WSjr.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-ChfoKBeL.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-CLVnUt0W.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-Bz-N9TLi.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-kqxwvNnX.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-t1fD2aNp.js";
import { r as agentCommandFromIngress } from "./agent-command-CbVp9Pf5.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-f0ChDlji.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-D3UQQKJS.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-DizcZeDL.js";
import { t as formatForLog } from "./ws-log-DhsA3eDx.js";
import { i as invokeNativeHookRelay } from "./native-hook-relay-BGuJNohn.js";
import { t as canExecRequestNode } from "./exec-defaults-CCf0sY5n.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-CBefIJHE.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-DA0r6E2a.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, t as getRemoteSkillEligibility } from "./skills-remote-DxHdZ133.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-C8N_meQ_.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-Bsh_trME.js";
import { a as getPendingDevicePairing, c as listDevicePairing, d as removePairedDevice, h as summarizeDeviceTokens, i as getPairedDevice, m as rotateDeviceToken, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as formatDevicePairingForbiddenMessage, t as approveDevicePairing, u as rejectDevicePairing } from "./device-pairing-D6nRUZtI.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-Brw03Qhr.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, S as recordTalkObservabilityEvent, a as listRealtimeVoiceProviders, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage } from "./session-runtime-Dq0mMi-m.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-WjcwfXKm.js";
import { n as createOutboundSendDeps } from "./deps-DNE6Ateb.js";
import "./agent-BBlv88BL.js";
import { n as consumeExecApprovalFollowupRuntimeHandoff, r as parseExecApprovalFollowupApprovalId } from "./bash-tools.exec-approval-followup-state-BQ2I13r4.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-DRXWC7bq.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-Dx5bfo4b.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-7GA1ARvN.js";
import "./server-constants-CxCvgJww.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-DE6J9HvH.js";
import { i as parseMessageWithAttachments, n as MediaOffloadError, o as resolveChatAttachmentMaxBytes, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-DET1X-it.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-rno0OLjC.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-1Ro-6o2k.js";
import { t as loadProviderUsageSummary } from "./provider-usage-BB6hNUY0.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-CBjiD40_.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-fpZxNGuO.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-iiOVUp-2.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-ZZEf9PEe.js";
import { t as buildChannelUiCatalog } from "./catalog-B63BPyAU.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-Cgb1r0-W.js";
import { s as normalizeUpdateChannel } from "./update-channels-B9FckqdT.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-CBUTClgL.js";
import { t as readConfiguredLogTail } from "./log-tail-0DgjOjut.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BhDTFMx3.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-ByiYbdVc.js";
import { t as buildChannelAccountSnapshot } from "./status-SoauQ-O_.js";
import { n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, r as evaluateChannelHealth, t as DEFAULT_CHANNEL_CONNECT_GRACE_MS } from "./channel-health-policy-DTlc3N8Q.js";
import { t as installSkill } from "./skills-install-Byp8_mSa.js";
import { o as prepareSecretsRuntimeSnapshot, s as refreshActiveSecretsRuntimeSnapshot } from "./runtime-RcP4oXTD.js";
import { a as installSkillArchiveFromPath, i as updateSkillsFromClawHub, o as validateRequestedSkillSlug, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-Drelw-fl.js";
import { r as readPackageVersion } from "./package-json-BVq9TbaW.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-DsED-AW2.js";
import { l as buildUpdateRestartSentinelPayload, r as CONTROL_PLANE_UPDATE_SENTINEL_META_ENV, t as CONTROL_PLANE_UPDATE_HANDOFF_STARTED_REASON } from "./update-control-plane-sentinel-CJdjMf9C.js";
import { t as MANAGED_SERVICE_UPDATE_HANDOFF_TEMP_PREFIX } from "./update-managed-service-handoff-cleanup-BLvZt2yJ.js";
import { t as getStatusSummary } from "./status.summary-BVcu79J1.js";
import "./status-dxRBf2ss.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-BTF2zcyq.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-26GaKEyE.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-BjFXyMFg.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-Cl0g5M4M.js";
import { i as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-DspHeq2w.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-CeqbP962.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-BeRnptKl.js";
import "./heartbeat-runner-Dd1Xn9LC.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-Ctpk1Tby.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-C373jnl3.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-C0brAGCR.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-iR-3w36K.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-DiXq1Vug.js";
import { o as resolveApprovalRequestRecipientConnIds } from "./approval-shared-CJblU2FF.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-Cqr2nhTt.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-BDAzYswu.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-0RAmVVJM.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-NokEzV78.js");
