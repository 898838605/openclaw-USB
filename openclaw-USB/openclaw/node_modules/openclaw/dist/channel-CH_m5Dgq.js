...
import { l as createScopedDmSecurityResolver, u as createTopLevelChannelConfigAdapter } from "./channel-config-helpers-DBgfYxUW.js";
import { n as formatPairingApproveHint } from "./helpers-DrdxqwF3.js";
...
import { t as createDirectDmPreCryptoGuardPolicy } from "./direct-dm-guard-policy-C_XTFR3i.js";
...
import { r as buildTrafficStatusSummary, t as buildPassiveChannelStatusSummary } from "./extension-shared-cqKVxaOp.js";
...
import { t as attachChannelToResult } from "./channel-send-result-CJQh3QAi.js";
import { n as NostrProfileSchema, t as NostrConfigSchema } from "./config-schema-g8iqFc_c.js";
import { a as resolveNostrAccount, c as SimplePool, d as verifyEvent, f as cbc, g as randomBytes, h as hexToBytes, i as resolveDefaultNostrAccountId, l as finalizeEvent, m as secp256k1, n as nostrSetupWizard, o as normalizePubkey, p as base64, r as listNostrAccountIds, s as validatePrivateKey, t as nostrSetupAdapter, u as getPublicKey } from "./setup-surface-BozFRo7a.js";
import { t as DEFAULT_RELAYS } from "./default-relays-Cmdf_9ad.js";
...
const startNostrGatewayAccount = async (ctx) => {
	...
	const bus = await startNostrBus({
		...
		onMessage: async (senderPubkey, text, reply, meta) => {
			...
			const { dispatchInboundDirectDmWithRuntime } = await import("./inbound-direct-dm-runtime-BOI5-slP.js");
