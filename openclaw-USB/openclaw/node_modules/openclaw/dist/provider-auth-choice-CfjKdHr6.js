...
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-DTXcmZXB.js";
...
import { n as openUrl } from "./browser-open-cpmfar7s.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-BOUzYbm9.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-OcYY62DM.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-CdLUIuOs.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-0zDayT6t.js");
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-UDWli14H.js") };
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-BuvGAOIP.js");
