...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-mqKSAeAo.js";
import { i as isNixMode } from "./paths-Cnwfh6dH.js";
import { _ as sleep } from "./utils-CKsuXgDI.js";
import { a as emitDiagnosticsTimelineEvent, o as isDiagnosticsTimelineEnabled } from "./plugin-metadata-snapshot-BxWkpxUl.js";
import { _ as clearCurrentPluginMetadataSnapshot, b as setCurrentPluginMetadataSnapshot } from "./plugin-registry-iimloLsx.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-Cm-b9RRj.js";
import { a as isDiagnosticsEnabled, b as runWithDiagnosticTraceContext, d as createDiagnosticTraceContext, l as setDiagnosticsEnabledForProcess } from "./diagnostic-events-CyaAsfPZ.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-LmgZvqF7.js";
...
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-Duxztt3o.js";
import { n as resolveGatewayAuth } from "./auth-resolve-BSzZWN7G.js";
import { A as applyConfigOverrides, c as promoteConfigSnapshotToLastKnownGood, i as getRuntimeConfig, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-DnGGugrj.js";
...
import { t as loadGatewayTlsRuntime$1 } from "./gateway-B06MGrRH.js";
...
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-x8yr89ni.js";
import { n as readGatewayRestartHandoffSync } from "./restart-handoff-Bw5uVDMz.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-q8Kl1Dsn.js";
import { C as createPluginGatewayMethodDescriptors, S as createGatewayMethodRegistry, x as createGatewayMethodDescriptorsFromHandlers } from "./loader-CxUWY2_6.js";
import { b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry } from "./runtime-nSi6iKFR.js";
import { i as resolveMainSessionKey } from "./main-session-BIlePcj4.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-BscvFMYw.js";
import "./sessions-BDnaolrd.js";
import { a as enqueueSystemEvent } from "./system-events-Coh4mKQt.js";
import { _ as stopDiagnosticHeartbeat, g as startDiagnosticHeartbeat } from "./diagnostic-Czpecr1T.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-BPy13KSf.js";
...
import { r as resolveCronStorePath } from "./store-BPccW2Ar.js";
import { a as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-state-B7rk2N8g.js";
import { o as setFallbackGatewayContextResolver } from "./server-plugins-CsMy0-xY.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-C-PxaRXk.js";
import { c as recordGatewayRestartTraceDetail, d as resumeGatewayRestartTraceFromHandoff, i as finishGatewayRestartTrace, l as recordGatewayRestartTraceSpan, n as collectGatewayProcessMemoryUsageMb, u as resumeGatewayRestartTraceFromEnv } from "./restart-trace-BdX3s0hL.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-Cj2ApAKX.js";
import { s as normalizePluginNodeCapabilityScopedUrl } from "./plugin-node-capability-f0ChDlji.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-DhsA3eDx.js";
import { t as createDefaultDeps } from "./deps-DNE6Ateb.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-DhkmnYvO.js";
import { c as setDefaultSecurityHeaders, r as sendGatewayAuthFailure } from "./http-common-DCT9aczG.js";
import { i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES } from "./server-constants-CxCvgJww.js";
import { t as GatewayLockError } from "./gateway-lock-BXavAMF0.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CecSBHUE.js";
...
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-kVJjnjaR.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-Cl0g5M4M.js";
import { i as getRequiredSharedGatewaySessionGeneration, r as enforceSharedGatewaySessionGenerationForConfigWrite } from "./server-shared-auth-generation-Bmvohd-X.js";
import { a as createToolEventRecipientRegistry, n as createChatRunState } from "./server-chat-state-s_vXsHNE.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-B_9gAlP0.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-DFItqHpK.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-BTlY8U9C.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-B-LolS4L.js";
import { n as isProtectedPluginRoutePathFromContext, r as resolvePluginRoutePathContext } from "./route-match-BxUQPPzM.js";
import { n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-hS42qZoR.js";
import { t as findMatchingPluginNodeCapabilityRoute } from "./route-capability-CTuMZOPW.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-BHJKZNeu.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-D2mAXl7E.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-Bm85tpTb.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-DxQ53H9I.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-BsUvVnOt.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-CdT8ok5l.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-NCjhcHH3.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-CnKjJkXt.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-UEAcfHYX.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-UZWZqZGd.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-De8pkHgj.js");
	return toolsInvokeHttpModulePromise;
}
function getPluginNodeCapabilityAuthModule() {
	pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth-7aX2tTgb.js");
	return pluginNodeCapabilityAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-Dy6DGJ9h.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-CMOgnIGA.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-B_K-WrIg.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-DMLLCEvq.js");
		...
		const handlePluginUpgrade = async (req, socket, head, pathContext, dispatchContext) => {
			...
			if (!loadedPluginUpgradeHandler) {
				const { createGatewayPluginUpgradeHandler } = await import("./plugins-http-DMLLCEvq.js");
...
async function __resetModelCatalogCacheForTest() {
	const { __resetModelCatalogCacheForTest: resetModelCatalogCacheForTest } = await import("./server-model-catalog-DhZ43L8i.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-HvPVN10T.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-YZ9gEIwL.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-BkbJHk_a.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-Cj-3lSwt.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
	return cachedStartupChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-BH-BIX9C.js");
...
const loadGatewayModelCatalog = async (...args) => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-DhZ43L8i.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-D7xGxcBi.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-Cedc8CbA.js");
	return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-B-9eTjy2.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-rpyFVX17.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-B5G0a8t1.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-CLg2iGZK.js");
	...
	const { createChannelManager } = await import("./server-channels-CB6PQpkL.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-DO5i0Tbq.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, gatewayRuntimeServices] = await Promise.all([import("./server-runtime-subscriptions-T2vPlCuU.js"), import("./server-runtime-services-DHDWrDgG.js")]);
		...
		const { createGatewayAuxHandlers } = await import("./server-aux-handlers-QRhgjmzm.js");
		const { coreGatewayHandlers } = await import("./server-methods-BAy3NbTS.js");
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-DG1MClHj.js"),
				import("./server-plugin-bootstrap-5vAl5ay7.js"),
				import("./services-Pe4tx9BN.js")
			]);
		...
		const { createGatewayRequestContext } = await import("./server-request-context-_Jjg0HXs.js");
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-5vAl5ay7.js");
		...
		const { attachGatewayWsHandlers } = await import("./server-ws-runtime-DeNw-k9S.js");
		const { listPluginNodeCapabilities } = await import("./route-capability-B9sJuRO8.js");
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-CuowM2si.js");
