...
import "./text-autolink-runtime-D7kYBWM4.js";
import { t as require_src } from "./src-DWsJRsz2.js";
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-Ckvj5sL_.js";
...
import { r as buildMatrixReactionContent } from "./reaction-common-bVnvlgHT.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-Dtb-b7ES.js";
import { t as fromBuffer } from "./lib-DjNFJccu.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-TFP6_lou.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-BE2h0otg.js";
import { l as toRatio, n as decodeString } from "./Util-Cf1vyaPo.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-CRkHYeGN.js";
import { t as APEv2Parser } from "./APEv2Parser-BvEP33It.js";
import { r as hasID3v1Header } from "./ID3v1Parser-BAjSTYhl.js";
import { i as isStrictDirectRoom } from "./direct-room-DHkWSqdP.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-CLfwW-dQ.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-CdRmecNL.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-Dsni15ih.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-DbSAfI6q.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DnwEUuUQ.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-q0tmAfqo.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-BQAQrJdd.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-CR507xDp.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-CAyYkvTg.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-BbqI4heo.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-BnA-BwsV.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-bcOntisg.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-BHw0b5NW.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-3Ni-7e86.js")).WaveParser;
	}
};
//#endregion
