...
import { p as resolvePayloadMediaUrls, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-UitMHHLq.js";
import { f as renderMessagePresentationFallbackText, l as normalizeMessagePresentation } from "./payload-y0EkMuyx.js";
import { n as resolveChannelGroupRequireMention, r as resolveChannelGroupToolsPolicy } from "./group-policy-DBJpi3xm.js";
import { n as resolveOutboundSendDep } from "./send-deps-BNHGsW8q.js";
import { t as clearAccountEntryFields } from "./config-helpers-DzHttzP9.js";
import "./error-runtime-Dvd9qNRG.js";
import "./string-coerce-runtime-PzdFg3e_.js";
import { i as resolveTelegramStartupProbeTimeoutMs } from "./request-timeouts-C7t6WhyV.js";
import "./state-paths-PlCZJrNb.js";
import { n as collectTelegramUnmentionedGroupIds, t as auditTelegramGroupMembership } from "./audit-C3rA6JEV.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-B_GhzhOy.js";
import "./channel-core-DEsbinUA.js";
import { t as resolveTelegramToken } from "./token-Da1wIAtd.js";
import { t as createAccountStatusSink } from "./channel-lifecycle.core-5vp7guB-.js";
import "./channel-policy-5OUFC0mF.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-DQayqUIf.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-B4Isf5wU.js";
import "./approval-delivery-runtime-Dj39vL-6.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-8l2u3xbE.js";
import { n as createChannelNativeOriginTargetResolver, t as createChannelApproverDmTargetResolver } from "./approval-native-helpers-Cd-vlOW7.js";
import "./approval-native-runtime-B2b7jU01.js";
import { a as resolveConfiguredFromCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-G3iKgelP.js";
import "./cli-runtime-Bmktbg4B.js";
import { c as createNestedAllowlistOverrideResolver, n as buildDmGroupAccountAllowlistAdapter } from "./allowlist-config-edit-BjBDXiaB.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-e9hGas1o.js";
import { _ as resolveEnabledConfiguredAccountId, d as createDefaultChannelRuntimeState, m as asString, o as buildTokenChannelStatusSummary, p as appendMatchMetadata, u as createComputedAccountStatusAdapter } from "./status-helpers-C-oqS7jT.js";
import "./channel-status-NcWRkUVm.js";
import "./channel-lifecycle-BcHpZXdV.js";
import { k as createChannelMessageAdapterFromOutbound } from "./channel-message-A0qNE-jd.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-CdXvFu9A.js";
import { i as createAttachedChannelResultAdapter, t as attachChannelToResult } from "./channel-send-result-CJQh3QAi.js";
import { o as resolveTelegramAccount, r as listTelegramAccountIds } from "./accounts-DJD04MYo.js";
import { i as parseTelegramTarget, n as normalizeTelegramChatId, r as normalizeTelegramLookupTarget } from "./targets-4zE9II_n.js";
import { a as telegramConfigAdapter, c as telegramSecurityAdapter, i as formatDuplicateTelegramTokenReason, n as createTelegramPluginBase, o as telegramSetupWizard, r as findTelegramTokenOwnerAccountId, s as telegramSetupAdapter, u as lookupTelegramChatId } from "./channel.setup-DOFx9Q1W.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-DHjJ-S7K.js";
import { c as resolveTelegramExecApprovalTarget, f as shouldSuppressLocalTelegramExecApprovalPrompt, i as isTelegramExecApprovalClientEnabled, n as isTelegramExecApprovalApprover, o as isTelegramExecApprovalTargetRecipient, r as isTelegramExecApprovalAuthorizedSender, t as getTelegramExecApprovalApprovers, u as shouldHandleTelegramExecApprovalRequest } from "./exec-approvals-A6dKzQdR.js";
import { J as parseTelegramReplyToMessageId, Y as parseTelegramThreadId, d as buildTelegramGroupPeerId, i as markdownToTelegramHtmlChunks, o as splitTelegramHtmlChunks } from "./format-AZK6G0is.js";
import { a as buildTelegramExecApprovalPendingPayload, c as normalizeTelegramBotInfo, i as releaseStoppedTelegramPollingLease, r as monitorTelegramProvider, s as telegramMessageActions$1, t as probeTelegram } from "./probe-2l5SF_IE2.js";
import { t as fingerprintTelegramBotToken } from "./token-fingerprint-BWEYnvki.js";
import { n as listTelegramDirectoryPeersFromConfig, t as listTelegramDirectoryGroupsFromConfig } from "./directory-config-D9JcaQop.js";
import { t as resolveTelegramInlineButtons } from "./button-types-BG0nAHqD.js";
import { t as resolveTelegramInteractiveTextFallback } from "./interactive-fallback-BlYz6a4I.js";
import { t as resolveTelegramReactionLevel } from "./reaction-level-DThvd5BS.js";
import { t as getTelegramRuntime } from "./runtime-BiBiyVfC.js";
import { t as parseTelegramTopicConversation } from "./topic-conversation-BUK2IzvP.js";
import { n as resolveTelegramSessionTarget, t as resolveTelegramSessionConversation } from "./session-conversation-lzCTNabP.js";
import { t as detectTelegramLegacyStateMigrations } from "./state-migrations-B0hEbqYe.js";
import { a as setTelegramThreadBindingMaxAgeBySessionKey, i as setTelegramThreadBindingIdleTimeoutBySessionKey, t as createTelegramThreadBindingManager } from "./thread-bindings-1cMvG9O1.js";
...
const telegramNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-V3MmmJIy.js")).telegramApprovalNativeRuntime
	})
});
...
async function loadTelegramSendModule$1() {
	telegramSendModulePromise$1 ??= import("./send-sjCsQP0p.js");
...
async function loadTelegramSendModule() {
	telegramSendModulePromise ??= import("./send-sjCsQP0p.js");
