...
import { t as setupWizardCommand } from "./onboard-nCJ5Y1Xt.js";
import JSON5 from "json5";
import fs from "node:fs/promises";
//#region src/commands/setup.ts
const JsonRecordSchema = record(string(), unknown());
const agentWorkspaceModuleLoader = createLazyImportLoader(() => import("./workspace-D50ElaxT.js"));
const configIOModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const configLoggingModuleLoader = createLazyImportLoader(() => import("./logging-CbbQ2CSd.js"));
...
async function resolveDefaultSessionTranscriptsDir() {
	const { resolveSessionTranscriptsDir } = await import("./sessions-BEVhRj-w.js");
