...
import { a as logWarn, r as logInfo } from "./logger-BGaqbYrv.js";
import { Y as getShellPathFromLoginShell, Z as resolveShellEnvFallbackTimeoutMs } from "./io-DnGGugrj.js";
...
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-JqYBZqnL.js";
...
import { d as sanitizeUserFacingText, f as formatExecDeniedUserMessage, m as parseExecApprovalResultText, p as isExecDeniedResultText } from "./sanitize-user-facing-text-BNhO6xXL.js";
import { n as getDiagnosticSessionState } from "./diagnostic-session-state-DQYCb1rS.js";
import { d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-Bana6VmY.js";
import { t as formatDurationCompact } from "./format-duration-CfCsYxBe.js";
import { a as drainSession, c as listFinishedSessions, d as markExited, f as setJobTtlMs, i as deleteSession, l as listRunningSessions, o as getFinishedSession, p as tail, s as getSession, u as markBackgrounded } from "./bash-process-registry-MVHTiscQ.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-BDBXUIxv.js";
import { o as failedTextResult, y as textResult } from "./common-Co_iMEX5.js";
import { t as callGatewayTool } from "./gateway-Bvxsd_oc.js";
import { c as describeInterpreterInlineEval, t as buildCommandPayloadCandidates } from "./risks-CBxA0dtf.js";
import { l as analyzeShellCommand, n as evaluateShellAllowlist, u as buildEnforcedShellCommand } from "./exec-approvals-allowlist-C-fc2faR.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-CP96k48V.js";
import { E as resolveExecApprovalAllowedDecisions, O as resolveExecApprovals, T as requiresExecApproval, c as hasDurableExecApproval, d as maxAsk, h as normalizeExecAsk, k as resolveExecApprovalsFromFile, o as addDurableCommandApproval, p as minSecurity, u as loadExecApprovals, w as requireValidExecTarget, x as recordAllowlistMatchesUse, y as persistAllowAlwaysPatterns } from "./exec-approvals-BqMmeDlh.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-BGrJMxP0.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-DN5gDi4F.js";
import "./delivery-context-Dq1H4ZT9.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-D4FQSC03.js";
import { t as sendMessage } from "./message-WM4EixnR.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-BPdfylFU.js";
import { r as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-VL-0TX7M.js";
import { u as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-CHDfCPTH.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-fV-FgDay.js";
import { t as getProcessSupervisor } from "./supervisor-BI7B2n3Y.js";
import { a as DEFAULT_PENDING_MAX_OUTPUT, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput } from "./bash-tools.exec-runtime-ePGeZhvd.js";
import { n as detectPolicyInlineEval } from "./policy-BBIK7N2i.js";
import { i as registerExecApprovalFollowupRuntimeHandoff, t as buildExecApprovalFollowupIdempotencyKey } from "./bash-tools.exec-approval-followup-state-BQ2I13r4.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-DRXWC7bq.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-Dx5bfo4b.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-CFplww6B.js";
