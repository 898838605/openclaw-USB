import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-AuEAawwp.js";
import { r as loadCrestodianOverview } from "./overview--JxWiFvI.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-D2_aJDyh.js")).planCrestodianCommand)({
		input,
		overview
	});
