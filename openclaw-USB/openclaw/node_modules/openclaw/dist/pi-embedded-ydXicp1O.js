...
import { o as resolveAgentExecutionContract, r as hasConfiguredModelFallbacks, v as resolveSessionAgentIds } from "./agent-scope-Cf7T6Ju7.js";
...
import { m as freezeDiagnosticTraceContext } from "./diagnostic-events-CyaAsfPZ.js";
...
import { i as isMarkdownCapableMessageChannel } from "./message-channel-JqYBZqnL.js";
import { n as resolveSafeTimeoutDelayMs } from "./timer-delay-Bp0llpsE.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime, c as resolveContextConfigProviderForRuntime, t as OPENAI_CODEX_PROVIDER_ID, u as resolveSelectedOpenAIPiRuntimeProvider } from "./openai-codex-routing-17ICsBr_.js";
import { t as resolveAgentHarnessPolicy } from "./policy-DYe4G92j.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-CKF4eCEZ.js";
import { a as resolveContextEngineOwnerPluginId, i as resolveContextEngine } from "./registry-CY4dANbm.js";
import { s as emitAgentPlanEvent } from "./agent-events-DVSiKwui.js";
import { t as extractAssistantTextForPhase } from "./chat-message-content-CjC9AtYE.js";
import { X as resolveProviderAuthProfileId, x as prepareProviderRuntimeAuth } from "./provider-runtime-Bzn5r2hY.js";
import { i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-BYnn-xRZ.js";
import { n as ensureOpenClawModelsJson } from "./models-config-hNCfzm-l.js";
import { t as formatMissingAuthError } from "./model-auth-runtime-shared-DAhI9GRn.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-DEIGMzB3.js";
import { l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-BNhO6xXL.js";
import { c as isTimeoutErrorMessage } from "./failover-matches-W8f_0sUm.js";
import "./runs-CfIOZroM.js";
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyPayloadText } from "./tokens-BlOFOAQM.js";
import { n as derivePromptTokens, o as normalizeUsage } from "./usage-C0ofRzYq.js";
import { n as sleepWithAbort } from "./backoff-Db80NPS1.js";
import { i as enqueueCommandInLane } from "./command-queue-CQS64N4-.js";
import { c as markReplyPayloadForSourceSuppressionDelivery, i as getReplyPayloadMetadata, l as setReplyPayloadMetadata, r as copyReplyPayloadMetadata } from "./reply-payload-DNKaYjcZ.js";
import { a as hasReplyPayloadContent } from "./payload-y0EkMuyx.js";
import { f as resolveToolLoopDetectionConfig, w as isStrictAgenticExecutionContractActive } from "./openclaw-tools-wLbjLILX.js";
import { C as createEmbeddedRunStageTracker, O as rotateTranscriptFileAfterCompaction, S as EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE, St as observeReplayMetadata, T as shouldWarnEmbeddedRunStageSummary, _ as resolveRateLimitProfileRotationLimit, _t as resolveReplayInvalidFlag, a as RUNTIME_AUTH_REFRESH_MARGIN_MS, b as createUsageAccumulator, bt as shouldTreatEmptyAssistantReplyAsSilent, c as buildErrorAgentMeta, ct as STRICT_AGENTIC_BLOCKED_TEXT, d as resolveActiveErrorContext, dt as resolveAttemptReplayMetadata, f as resolveFinalAssistantRawText, ft as resolveEmptyResponseRetryInstruction, g as resolveOverloadProfileRotationLimit, gt as resolveReasoningOnlyRetryInstruction, h as resolveOverloadFailoverBackoffMs, ht as resolvePlanningOnlyRetryLimit, i as selectAgentHarness, k as shouldRotateCompactionTranscript, l as buildUsageAgentMetaFields, lt as extractPlanningOnlyPlanDetails, m as resolveMaxRunRetryIterations, mt as resolvePlanningOnlyRetryInstruction, o as RUNTIME_AUTH_REFRESH_MIN_DELAY_MS, p as resolveFinalAssistantVisibleText, pt as resolveIncompleteTurnPayloadText, r as runAgentHarnessAttempt, s as RUNTIME_AUTH_REFRESH_RETRY_MS, t as maybeCompactAgentHarnessSession, u as createCompactionDiagId, ut as resolveAckExecutionFastPathInstruction, v as resolveReportedModelRef, vt as resolveRunLivenessState, w as formatEmbeddedRunStageSummary, x as mergeUsageIntoAccumulator, xt as createEmbeddedRunReplayState, y as scrubAnthropicRefusalMagic, yt as resolveSilentToolResultReplyPayload } from "./selection-Cr-9-UpD.js";
import { p as buildAgentHookContextChannelFields, r as forgetPromptBuildDrainCacheForRun } from "./attempt.prompt-helpers-CiOyBHXW.js";
import { i as listActiveProcessSessionReferences, n as resolveEmbeddedCompactionTarget, r as resolveContextEngineCapabilities, t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context-Ba93y_1g.js";
import { o as normalizeTextForComparison, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-BceuaEk2.js";
import { a as formatAssistantErrorText, b as parseImageSizeError, c as isBillingAssistantError, f as isFailoverAssistantError, h as isRateLimitAssistantError, i as extractObservedOverflowTokenCount, m as isLikelyContextOverflowError, p as isFailoverErrorMessage, s as isAuthAssistantError, t as classifyFailoverReason, u as isCompactionFailureError, y as parseImageDimensionError } from "./errors-Da1M4x-G.js";
import { n as resolveProcessToolScopeKey } from "./pi-tools-BdpK2b88.js";
import { n as coerceToFailoverError, r as describeFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-Dds-8GA6.js";
import "./auth-profiles-C6JtuKOs.js";
import { n as markAuthProfileSuccess } from "./profiles-DdWlNiEB.js";
import { i as resolveAuthProfileOrder, l as isProfileInCooldown, r as resolveAuthProfileEligibility } from "./order-BpP0LHg3.js";
import { d as sanitizeRuntimeProviderRequestOverrides, o as resolveProviderRequestConfig } from "./provider-request-config-C5riPuMI.js";
import { t as redactIdentifier } from "./redact-identifier-CVOVekVa.js";
import { t as sanitizeForConsole } from "./console-sanitize-DFgfHPLM.js";
import { a as markAuthProfileFailure, s as resolveProfilesUnavailableReason } from "./usage-D106LtCH.js";
import { f as shouldPreferExplicitConfigApiKeyAuth, n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride } from "./model-auth-DOcJ8K8t.js";
import { l as runAgentCleanupStep } from "./attempt.tool-run-context-D_w-VPuV.js";
import { c as retireSessionMcpRuntime, l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-kBY5eAjg.js";
import "./pi-bundle-mcp-tools-DhOKiIBF.js";
import { i as createHeartbeatToolResponsePayload } from "./heartbeat-tool-response-WO7_7Mn8.js";
import { i as extractAssistantVisibleText, r as extractAssistantThinking } from "./pi-embedded-utils-D4Sg9KBJ.js";
import { n as isLikelyMutatingToolName } from "./tool-mutation-BYghAeeK.js";
...
import { u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-14zpJ_6_.js";
import { a as suspendSession, c as shouldAllowCooldownProbeForReason, i as resolveSessionSuspensionReason, l as buildApiErrorObservationFields, o as LiveSessionModelSwitchError } from "./model-fallback-DPQE5cWR.js";
import { t as log$1 } from "./logger-CXU-7egZ.js";
import { d as resolveLiveToolResultMaxChars, f as sessionLikelyHasOversizedToolResults, p as truncateOversizedToolResultsInSession } from "./preemptive-compaction-Cw1bzYz-.js";
import "./tool-split-CuKUxPR_.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-B3PjuhOU.js";
import { i as resolveStoredSessionKeyForSessionId, r as resolveSessionKeyForRequest } from "./session-D_NbRatC.js";
import { t as ensureContextEnginesInitialized } from "./init-T1SICBsj.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-DCNP8-u1.js";
import "./extra-params-BWj0nv6A.js";
import { a as resolveContextWindowInfo, i as formatContextWindowWarningMessage, n as evaluateContextWindowGuard, r as formatContextWindowBlockMessage } from "./context-window-guard-B-sf7zbO.js";
...
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-DYXJ836t.js";
import { n as resolveModelAsync } from "./model-CjE75UNk.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-_cQprMjo.js";
import { n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-DTXLfQ_0.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-qWehDY77.js";
import { r as buildAgentRuntimePlan } from "./build-DFVsSnQY.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-I80x93MB.js";
