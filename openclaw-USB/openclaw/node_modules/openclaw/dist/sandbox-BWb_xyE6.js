...
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-DgH4e5SP.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, x as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, y as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-DFlUxem6.js";
import { n as isToolAllowed } from "./tool-policy-CmQfGGB2.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-Dw9S3RVy.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-D-UWDWG8.js";
import { c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-DNgRLjQy.js";
import { f as isSameSsrFPolicy } from "./ssrf-C5hZu3Z5.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-7-GotF25.js";
import { C as readBrowserRegistry, D as updateBrowserRegistry, E as removeRegistryEntry, O as updateRegistry, T as removeBrowserRegistryEntry, _ as resolveSandboxAgentId, a as execDocker, b as slugifySessionKey, c as isDockerDaemonUnavailable, g as appendWorkspaceMountArgs, k as computeSandboxBrowserConfigHash, l as readDockerContainerEnvVar, m as resolveDockerEnvPolicyEpoch, n as dockerContainerState, p as readDockerPort, s as formatDockerDaemonUnavailableError, t as buildSandboxCreateArgs, u as readDockerContainerLabel, v as resolveSandboxScopeKey, w as readRegistry, y as resolveSandboxWorkspaceDir } from "./docker-D7OV8usY.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-DO9J5C7H.js";
import { D as buildPinnedWritePlan, E as buildPinnedRenamePlan, O as dockerSandboxBackendManager, T as buildPinnedRemovePlan, a as getSandboxBackendManager, b as relativePathEscapesContainerRoot, k as runDockerSandboxShellCommand, n as startBrowserBridgeServer, r as stopBrowserBridgeServer, s as requireSandboxBackendFactory, t as BROWSER_BRIDGES, v as isPathInsideContainerRoot, w as buildPinnedMkdirpPlan, y as normalizeContainerPath } from "./browser-bridges-DxFJLexE.js";
	...
	if (workspaceDir === sandboxWorkspaceDir) {
		...
		if (cfg.workspaceAccess !== "rw") try {
			const [{ getRemoteSkillEligibility }, { canExecRequestNode }, { syncSkillsToWorkspace }] = await Promise.all([
				import("./skills-remote-C3RMF9e_.js"),
				import("./exec-defaults-Dp9ChCRe.js"),
				import("./skills-UvXOxYTF.js")
			]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-CSM_ntSv.js")).maybePruneSandboxes(cfg);
