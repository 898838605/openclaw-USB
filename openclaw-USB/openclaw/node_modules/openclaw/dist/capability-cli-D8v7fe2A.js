...
import { a as resolveAgentDir, c as resolveDefaultAgentId } from "./agent-scope-config-DUwbsKjv.js";
...
import { p as normalizeThinkLevel } from "./thinking-CvQif4jm.js";
...
import { d as randomIdempotencyKey, i as callGateway } from "./call-NAbH1Jz8.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-CB8LiTKl.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-DWfYSjGf.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-BYnn-xRZ.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-BKKLDOm5.js";
import { r as loadModelCatalog } from "./model-catalog-Nx2O35da.js";
import { c as getImageMetadata, s as convertHeicToJpeg } from "./media-services-Di9wZ6pu.js";
...
import { t as buildExplicitSessionIdSessionKey } from "./session-D_NbRatC.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-5vRBDqE0.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets-aoyOGHQ6.js";
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, d as listSpeechVoices, f as listTtsPersonas, h as resolveExplicitTtsOverrides, k as textToSpeech, o as getTtsPersona, s as getTtsProvider, v as resolveTtsPrefsPath } from "./tts-runtime-BVVdE3da.js";
import "./tts-BjNB0m2z.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-BjluIs3B.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-SG_Y25fQ.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-DZMCccqQ.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BWjOW7PF.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-DYNab69M.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-DFi6Nu5b.js";
import { n as runCommandWithRuntime } from "./cli-utils-BtJVvQGO.js";
import { t as removeCommandByName } from "./command-tree-5Vm9crgI.js";
import { t as collectOption } from "./helpers-Cdd7Mirr.js";
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-DN8fJAys.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-Cgb1r0-W.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-T5yiBdNG.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-CLO97JaP.js");
