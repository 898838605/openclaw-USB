...
import { n as shouldEagerRegisterSubcommands } from "./command-registration-policy-vWeBKd3X.js";
import { t as addGatewayClientOptions } from "./gateway-rpc-XFKZDWZT.js";
import { t as formatHelpExamples } from "./help-format-B0QfO_8n.js";
import { i as registerCommandGroups } from "./register-command-groups-D5yrfgW4.js";
import "./cli-runtime-Bmktbg4B.js";
import "./core-api-DbQx-xZI.js";
...
const browserCommandGroupDefinitions = [
	{
		...
		register: async (args) => {
			(await import("./browser-cli-manage-2HNp1uCy.js")).registerBrowserManageCommands(args.browser, args.parentOpts);
		}
	},
	{
		...
		register: async (args) => {
			(await import("./browser-cli-inspect-CTX5vbT0.js")).registerBrowserInspectCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-input-BAku6464.js")).registerBrowserActionInputCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-observe-BDc7aB-E.js")).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-debug-BjEUqIWW.js")).registerBrowserDebugCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-state-cNxpWVIB.js")).registerBrowserStateCommands(args.browser, args.parentOpts);
		}
	}
];
