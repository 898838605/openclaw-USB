...
import { C as resolvePluginControlPlaneFingerprint } from "./plugin-registry-iimloLsx.js";
...
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-Bzn5r2hY.js";
...
import { u as isGoogleModelApi } from "./pi-embedded-helpers-BceuaEk2.js";
...
import { t as pluginRegistrationContractRegistry } from "./registry-ChX5Ngmg.js";
import { t as log$1 } from "./logger-CXU-7egZ.js";
import { b as shouldPreserveThinkingBlocks } from "./provider-model-shared-DulLtCye.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-DMHlKYEK.js");
