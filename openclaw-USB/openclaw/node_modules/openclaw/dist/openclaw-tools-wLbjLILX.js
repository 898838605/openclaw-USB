...
import { _ as resolveSessionAgentId, a as resolveAgentEffectiveModelPrimary, o as resolveAgentExecutionContract, v as resolveSessionAgentIds } from "./agent-scope-Cf7T6Ju7.js";
...
import { n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-DUwbsKjv.js";
import { i as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-BxWkpxUl.js";
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-M9JN_JCw.js";
import { i as resolveManifestContractOwnerPluginId, v as getCurrentPluginMetadataSnapshot } from "./plugin-registry-iimloLsx.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-Cm-b9RRj.js";
import { t as createSubsystemLogger } from "./subsystem-LmgZvqF7.js";
import { t as logDebug } from "./logger-BGaqbYrv.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-DnGGugrj.js";
import { h as isWindowsDrivePath } from "./archive-BIRRxQjC.js";
import { n as getActivePluginRegistryWorkspaceDirFromState } from "./runtime-state-D14rXNRL.js";
import { n as modelKey } from "./model-ref-shared-DTXcmZXB.js";
...
import { t as getProviderEnvVars } from "./provider-env-vars-CDIyh39z.js";
...
import { o as normalizeChannelId } from "./registry-O-m2UOqu.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-wu-8nEST.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-rsgWXY6u.js";
import { s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-JqYBZqnL.js";
...
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-Bs7SHB8Y.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-CxUWY2_6.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-Ci62WSre.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-DVSiKwui.js";
import { n as assertSandboxPath } from "./sandbox-paths-DgH4e5SP.js";
import "./local-file-access-Bd-6sdA_.js";
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-DF9GO5GC.js";
import { h as stringifyRouteThreadId } from "./channel-route-cS6L3bdG.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-BuB7h14N.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-RbVDOqFp.js";
import { C as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-DjaY7SAt.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-OCFvwkK7.js";
import { n as resolveSessionConversationRef } from "./session-conversation-G0atx1to.js";
...
import { u as extractDeliveryInfo } from "./sessions-BDnaolrd.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-DWfYSjGf.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-Bzn5r2hY.js";
import { i as buildModelAliasIndex, x as resolveModelRefFromString } from "./model-selection-shared-CDpQv6TV.js";
import { n as modelKey$1, r as normalizeModelRef } from "./model-selection-normalize-mHTe5OFG.js";
import { n as ensureOpenClawModelsJson } from "./models-config-hNCfzm-l.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-BKKLDOm5.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-CH0hjbpb.js";
import { n as requireApiKey } from "./model-auth-runtime-shared-DAhI9GRn.js";
import { r as loadModelCatalog } from "./model-catalog-Nx2O35da.js";
import { n as extractTextFromChatContent } from "./chat-content-CQblFdcW.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-BG-87G2B.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-tc_il70a.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-BgXQqjG6.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-BlOFOAQM.js";
import { f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes, x as jsonUtf8Bytes } from "./session-utils.fs-D_3ZT9EK.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-CD5wJvRg.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-DiEYEgiu.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-BdX6w4bx.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-Bana6VmY.js";
import "./tool-policy-Ba_X4mUa.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-Cclzh8C-.js";
import { c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, l as findAcpUnsupportedInheritedToolDeny, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-8of-rAVb.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-C9NZ6JC0.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-Cbuy7CKE.js";
import { a as resolvePluginTools } from "./tools-uSSc1OHx.js";
import { t as canonicalizeBase64 } from "./base64-s-D6TLy9.js";
import { c as getImageMetadata } from "./media-services-Di9wZ6pu.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-CM7YOmsC.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-CxOvXCpK.js";
import { d as wrapToolWithBeforeToolCallHook, g as listChannelSupportedActions, l as isToolWrappedWithBeforeToolCallHook, m as listAllChannelSupportedActions } from "./pi-tools.before-tool-call-CPvWc0ME.js";
import { i as stringEnum, n as channelTargetsSchema, r as optionalStringEnum, t as channelTargetSchema } from "./typebox-BDpo_TDv.js";
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-Co_iMEX5.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-Bvxsd_oc.js";
import "./auth-profiles-C6JtuKOs.js";
import { n as resolveApiKeyForProfile } from "./oauth-CRg1yKdy.js";
import { n as listProfilesForProvider } from "./profile-list-CdhQb6vz.js";
import { i as resolveAuthProfileOrder } from "./order-BpP0LHg3.js";
import { i as getCustomProviderApiKey, r as getApiKeyForModel } from "./model-auth-DOcJ8K8t.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-WO7_7Mn8.js";
import { n as extractAssistantText } from "./pi-embedded-utils-D4Sg9KBJ.js";
import { i as loadSessionEntryByKey, m as mediaUrlsFromGeneratedAttachments, p as formatGeneratedAttachmentLines, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-14zpJ_6_.js";
import { n as runWithImageModelFallback } from "./model-fallback-DPQE5cWR.js";
import "./delivery-context-Dq1H4ZT9.js";
...
import { o as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-C_PTy4XI.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-COQSV8xJ.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-B2QpwHW-.js";
import { r as stripToolMessages } from "./chat-history-text-Bewa9VQr.js";
import { c as resolveCronCreationDelivery, i as resolveCronCurrentSessionTarget, n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-BAqu15pO.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-DrxsiMCN.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-Defxe--T.js";
import { t as inferLegacyName } from "./normalize-6g0X5x2k.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-CTo3KgCj.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-C6pAlzEC.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-BjkRdQdE.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-2RI1_GDE.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-CXUOBPgp.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-CfI0UwMF.js";
import { u as saveMediaBuffer } from "./store-BXoGMoVY.js";
import { t as SsrFBlockedError } from "./ssrf-C5hZu3Z5.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-DU4SkHCx.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-BUAEM0Ff.js";
import { r as getDefaultLocalRoots } from "./local-media-access-CpaCNVSk.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-ai2PKNC2.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-DJcWP2LC.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BguSq9bK.js";
import { a as resolveConfiguredImageModelRefs, c as coerceToolModelConfig, d as resolveDefaultModelRef, l as hasAuthForProvider, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl, s as buildToolModelConfigFromCandidates, u as hasToolModelConfig$1 } from "./image-tool.helpers-eBkuPyRb.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-DJGvoo6P.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-VkGQnd4R.js";
import { n as isMinimaxVlmProvider } from "./minimax-vlm-BjwG15R3.js";
import { n as normalizeMediaProviderId } from "./provider-id-4cQ_JYCX.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-BM83MsOa.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-CE59I2Hc.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-5vRBDqE0.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-C59ZZLdv.js";
import { s as resolveTimeoutMs } from "./resolve-CisQt5tP.js";
import { t as buildProviderRegistry } from "./runner-C_ku5cLD.js";
import "./media-understanding-DVVoKayb.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-ChU3jRUJ.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-DXSIj8bc.js";
import { d as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-aoyOGHQ6.js";
import { a as SHARED_POLL_CREATION_PARAM_NAMES, i as POLL_CREATION_PARAM_DEFS, n as runMessageAction, r as resolveAllowedMessageActions, t as getToolResult } from "./message-action-runner-Bs3VChcx.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-0XDT5-N4.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-qE6O62ky.js";
import { t as parseTimeoutMs } from "./parse-timeout-DCVb1n84.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-8Kss4bDm.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-BPdfylFU.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-CV_YuyV_.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-CxPGc_c_.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-BJT9dZia.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-ppHZoKvo.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-C1sTejoQ.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-BqKayNY5.js";
import { _ as isReplySkip, f as runAgentStep, g as isNonDeliverableSessionsReply, h as isAnnounceSkip, m as REPLY_SKIP_TOKEN, p as ANNOUNCE_SKIP_TOKEN } from "./subagent-session-cleanup-BplmfAcT.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-w3ZxYBkU.js";
import { p as registerSubagentRun } from "./subagent-registry-Bu5qGLSl.js";
import { a as resolveSubagentSpawnOwnership, i as normalizeSubagentTaskName, n as SUBAGENT_SPAWN_CONTEXT_MODES, r as SUBAGENT_SPAWN_MODES, t as spawnSubagentDirect } from "./subagent-spawn-BEF7uA0s.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-D158FqTQ.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-C-hAZyhA.js";
import { k as textToSpeech } from "./tts-runtime-BVVdE3da.js";
import "./tts-BjNB0m2z.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-48yqfPjW.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-BK_bg8Tv.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-BjluIs3B.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-Bh9UoUbE.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-CJby-OtS.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-C0BZd68j.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-B5rPf4r6.js";
import { i as runWebSearch } from "./runtime-SG_Y25fQ.js";
import "./web-search-provider-common-JxMQYKIk.js";
...
async function tryDeliverMediaGenerationFailureDirect(params) {
	...
	try {
		const { sendMessage } = await import("./task-registry-delivery-runtime-CzbDi5Qp.js");
		await sendMessage({
			cfg: params.config,
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-D5BLgL4L.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-k2ELR-fv.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-BZAOsq1M.js"));
...
//#endregion
export { resolveOpenClawPluginToolsForOptions as C, isEmbeddedMode as D, stripProviderPrefix as E, setEmbeddedMode as O, sniffMimeFromBase64 as S, isStrictAgenticSupportedProviderModel as T, createSandboxedReadTool as _, generateMusic as a, wrapToolWorkspaceRootGuard as b, buildActiveImageGenerationTaskPromptContextForSession as c, normalizeCronJobPatch as d, resolveToolLoopDetectionConfig as f, createSandboxedEditTool as g, createOpenClawReadTool as h, buildActiveMusicGenerationTaskPromptContextForSession as i, isParentOwnedBackgroundAcpSession as k, normalizeCronJobCreate as l, createHostWorkspaceWriteTool as m, buildActiveVideoGenerationTaskPromptContextForSession as n, listRuntimeMusicGenerationProviders as o, createHostWorkspaceEditTool as p, triggerSessionPatchHook as r, listSupportedMusicGenerationModes as s, createOpenClawTools as t, normalizeCronJobInput as u, createSandboxedWriteTool as v, isStrictAgenticExecutionContractActive as w, wrapToolWorkspaceRootGuardWithOptions as x, wrapToolMemoryFlushAppendOnlyWrite as y };
