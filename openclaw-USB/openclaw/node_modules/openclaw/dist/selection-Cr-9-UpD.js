...
import { t as isTruthyEnvValue } from "./env-mqKSAeAo.js";
...
import { v as resolveSessionAgentIds } from "./agent-scope-Cf7T6Ju7.js";
...
import { a as resolveAgentDir, i as resolveAgentContextLimits, r as resolveAgentConfig } from "./agent-scope-config-DUwbsKjv.js";
...
import { v as getCurrentPluginMetadataSnapshot } from "./plugin-registry-iimloLsx.js";
import { f as createDiagnosticTraceContextFromActiveScope, i as emitTrustedDiagnosticEvent, m as freezeDiagnosticTraceContext, p as formatDiagnosticTraceparent, u as createChildDiagnosticTraceContext } from "./diagnostic-events-CyaAsfPZ.js";
import { t as createSubsystemLogger } from "./subsystem-LmgZvqF7.js";
import { i as getRuntimeConfig } from "./io-DnGGugrj.js";
...
import { a as normalizeAnyChannelId } from "./registry-O-m2UOqu.js";
...
import { t as resolveAgentHarnessPolicy } from "./policy-DYe4G92j.js";
import { a as listRegisteredAgentHarnesses, r as getRegisteredAgentHarness } from "./registry-Bzhk9nmO.js";
import { T as getCompactionProvider } from "./loader-CxUWY2_6.js";
import { O as listRegisteredPluginAgentPromptGuidance } from "./types-BaOU_7l0.js";
import { l as fireAndForgetBoundedHook, s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-CKF4eCEZ.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-nSi6iKFR.js";
import { a as resolveContextEngineOwnerPluginId } from "./registry-CY4dANbm.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-DVSiKwui.js";
import { u as resolveStorePath } from "./paths-RbVDOqFp.js";
import { D as isCacheEnabled, O as resolveCacheTtlMs, T as createExpiringMapCache, t as loadSessionStore } from "./store-load-DjaY7SAt.js";
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath, n as TRAJECTORY_RUNTIME_EVENT_MAX_BYTES, o as resolveTrajectoryPointerOpenFlags } from "./paths-Ox1wtj8T.js";
import { c as updateSessionStoreEntry, i as runQuotaSuspensionMaintenance } from "./store-CmwzJ9N6.js";
import { m as MAX_IMAGE_BYTES } from "./mime-DWfYSjGf.js";
import { u as redactTranscriptMessage } from "./transcript-BEv_N5f2.js";
...
import { a as acquireSessionWriteLock, f as resolveSessionWriteLockOptions, l as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-Bb-tL9Bo.js";
...
import { s as resolveDefaultModelForAgent } from "./model-selection-BKKLDOm5.js";
import { t as stableStringify } from "./stable-stringify-B0xg3Ods.js";
import { t as resolveAgentTimeoutMs } from "./timeout-Dkhxn08A.js";
import { d as stripRuntimeContextCustomMessages, l as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-of4azzBy.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-BE7EsYqI.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-CQblFdcW.js";
import { a as stripDowngradedToolCallText, d as findFinalTagMatches, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-BG-87G2B.js";
import { m as parseExecApprovalResultText } from "./sanitize-user-facing-text-BNhO6xXL.js";
import { h as updateActiveEmbeddedRunSnapshot, m as setActiveEmbeddedRun, r as clearActiveEmbeddedRun } from "./runs-CfIOZroM.js";
...
import { C as stripInternalMetadataForDisplay, S as jsonUtf8BytesOrInfinity, b as firstEnumerableOwnKeys, y as boundedJsonUtf8Bytes } from "./session-utils.fs-D_3ZT9EK.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage } from "./usage-C0ofRzYq.js";
import { t as estimateStringChars } from "./cjk-chars-BRUBfQGD.js";
import { t as parseInlineDirectives } from "./directive-tags-D5cnXRTK.js";
import { l as setReplyPayloadMetadata } from "./reply-payload-DNKaYjcZ.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-UitMHHLq.js";
import { D as isEmbeddedMode, E as stripProviderPrefix, T as isStrictAgenticSupportedProviderModel, f as resolveToolLoopDetectionConfig } from "./openclaw-tools-wLbjLILX.js";
import { t as resolveAccountEntry } from "./account-lookup-BiGhslDA.js";
import { n as matchesAnyGlobPattern, t as compileGlobPatterns } from "./glob-pattern-BWfO3cb6.js";
import { i as normalizeToolName, n as expandToolGroups } from "./tool-policy-shared-Bana6VmY.js";
import "./tool-policy-Ba_X4mUa.js";
import { o as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-8of-rAVb.js";
import { i as resolveInheritedToolPolicyForSession, n as resolveEffectiveToolPolicy, o as resolveSubagentToolPolicyForSession, r as resolveGroupToolPolicy } from "./pi-tools.policy-DT-lAngt.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-D-UWDWG8.js";
import { t as resolveSenderToolPolicy } from "./sender-tool-policy-CPruMVfk.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-C9NZ6JC0.js";
import { u as stripHeartbeatToken } from "./heartbeat-BCpYGBga.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-cs_o3CxY.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-BA9nzlHH.js";
import { t as getMachineDisplayName } from "./machine-name-BPbJWqFR.js";
...
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-DWAuHLb9.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-2_jl3w5h.js";
import { i as getPluginToolMeta } from "./tools-uSSc1OHx.js";
import { n as redactConfigObject } from "./redact-snapshot-DiLP25fi.js";
import { n as resolveCommitHash } from "./git-commit-BP7VYO-H.js";
import { t as resolveOsSummary } from "./os-summary-87OQbWp8.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-CeV6PjAr.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-CWkNNGzJ.js";
import { d as parseBooleanValue } from "./frontmatter-BUzg4PAR.js";
import { i as generateSecureToken } from "./secure-random-CNLiQP3k.js";
import { i as listActiveProcessSessionReferences } from "./compaction-runtime-context-Ba93y_1g.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-OP6llAL2.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-DNgRLjQy.js";
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-ChGbGQGS.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-dq-MAW8F.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-Da1M4x-G.js";
import { n as extractToolResultId, o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-D3__AAZ6.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-CM7YOmsC.js";
import { _ as resolveChannelMessageToolHints, g as listChannelSupportedActions, v as resolveChannelPromptCapabilities, y as resolveChannelReactionGuidance } from "./pi-tools.before-tool-call-CPvWc0ME.js";
import { r as optionalStringEnum } from "./typebox-BDpo_TDv.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-BL3TsRwh.js";
import { i as asToolParamsRecord, l as jsonResult, r as ToolInputError } from "./common-Co_iMEX5.js";
...
import { t as sanitizeForConsole } from "./console-sanitize-DFgfHPLM.js";
import { u as resolveModelAuthMode } from "./model-auth-DOcJ8K8t.js";
import { S as supportsModelTools, _ as sanitizeToolArgs, a as logAgentRuntimeToolDiagnostics, b as isMessagingTool, d as extractToolErrorMessage, f as extractToolResultMediaArtifact, g as isToolResultTimedOut, h as isToolResultError, i as shouldAllowProviderOwnedThinkingReplay, l as runAgentCleanupStep, m as filterToolResultMediaUrls, n as createAgentToolResultMiddlewareRunner, o as normalizeAgentRuntimeTools, p as extractToolResultText$1, r as resolveTranscriptPolicy, t as buildEmbeddedAttemptToolRunContext, u as extractMessagingToolSend, v as sanitizeToolResult, x as isMessagingToolSendAction, y as collectTextContentBlocks } from "./attempt.tool-run-context-D_w-VPuV.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-BxP37gql.js";
import { o as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-kBY5eAjg.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-Cv7KdL41.js";
import "./pi-bundle-mcp-tools-DhOKiIBF.js";
import { o as normalizeHeartbeatToolResponse } from "./heartbeat-tool-response-WO7_7Mn8.js";
import { r as parseFenceSpans } from "./fences-DRqQ23-p.js";
import { r as splitMediaFromOutput } from "./parse-Cr-UcIbh.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-BYghAeeK.js";
import { u as parseReplyDirectives } from "./payloads-BsXJf6bR.js";
import { j as formatToolAggregate } from "./channel-streaming-OghHUGgH.js";
import { l as hasCommittedMessagingToolDeliveryEvidence, m as mediaUrlsFromGeneratedAttachments, u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-14zpJ_6_.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-I2nATHx8.js";
import { l as buildApiErrorObservationFields, s as MissingAgentHarnessError, u as buildTextObservationFields } from "./model-fallback-DPQE5cWR.js";
import { t as log$5 } from "./logger-CXU-7egZ.js";
import { _ as createPreparedEmbeddedPiSettingsManager, a as computeAdaptiveChunkRatio, c as resolveContextWindowTokens$1, d as resolveLiveToolResultMaxChars, g as formatContextLimitTruncationNotice, h as truncateToolResultMessage, i as SUMMARIZATION_OVERHEAD_TOKENS, l as summarizeInStages, m as truncateOversizedToolResultsInSessionManager, n as shouldPreemptivelyCompactBeforePrompt, o as estimateMessagesTokens, s as pruneHistoryForContextShare, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-Cw1bzYz-.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-CpBzy06U.js";
import { a as toClientToolDefinitions, n as createClientToolNameConflictError, r as findClientToolNameConflicts, t as splitSdkTools } from "./tool-split-CuKUxPR_.js";
import { c as resolveMainSessionAlias, s as resolveInternalSessionKey } from "./sessions-helpers-B2QpwHW-.js";
import { r as wrapUntrustedPromptDataBlock, t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-DTdQYDUE.js";
...
import { n as buildSubagentList } from "./subagent-list-D158FqTQ.js";
import { o as listControlledSubagentRuns } from "./subagent-control-C-hAZyhA.js";
import { r as createBoundaryAwareStreamFnForModel, t as registerProviderStreamForModel } from "./provider-stream-D4qSxrOO.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-CtPUmfh_.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-CPpXRm84.js";
import { C as buildCopilotDynamicHeaders, _ as mergeTransportHeaders, w as hasCopilotVisionInput, x as buildGuardedModelFetch, y as sanitizeTransportPayloadText } from "./openai-transport-stream-C7fXTJ-U.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-BUFdKx9z.js";
import { o as resolveSandboxContext } from "./sandbox-BWb_xyE6.js";
import { a as getRawSessionAppendMessage, l as readTranscriptFileState, o as setRawSessionAppendMessage, s as TranscriptFileState, t as runContextEngineMaintenance, u as writeTranscriptFileAtomic } from "./context-engine-maintenance-DCNP8-u1.js";
import { t as detectRuntimeShell } from "./shell-utils-CiLpmiMF.js";
import { i as resolveSkillRuntimeConfig, n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-CQPQWgSz.js";
import { o as loadWorkspaceSkillEntries, s as resolveSkillsPromptForRun } from "./workspace-WZoAbmov.js";
import "./skills-BVKiIfvH.js";
import { n as resolveSystemPromptOverride, t as buildSystemPromptReport } from "./system-prompt-report-DvbTO3Be.js";
import { i as resolveUserTimezone } from "./date-time-BiN9I3Hk.js";
import { n as appendAgentBootstrapSystemPromptSupplement, o as buildSystemPromptParams, r as appendModelIdentitySystemPrompt, t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-DMvdusoE.js";
import "./tool-loop-detection-jwWWnVz-.js";
import { C as isAnthropicModelRef, S as isAnthropicFamilyCacheTtlEligible, a as createCodexNativeWebSearchWrapper } from "./proxy-stream-wrappers-BMQodsQl.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-BWj0nv6A.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-N-bAXOsL.js";
import { a as resolveContextWindowInfo } from "./context-window-guard-B-sf7zbO.js";
import { n as resolveCronStyleNow } from "./current-time-BhwtlG1N.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-BypeE2NS.js";
import "./query-B2ZDzA4F.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-B06vbGWS.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-nLqHLSOM.js";
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-KnmwyREG.js";
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-BzEG62QK.js";
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, t as assembleHarnessContextEngine } from "./context-engine-lifecycle-BXh-wHNG.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-6MKiS5oS.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-DU8TjsXR.js";
import { t as detectAndLoadPromptImages } from "./images-DfXgs4Dc.js";
import { a as queueRuntimeContextForNextTurn, o as resolveRuntimeContextPromptParts, r as buildRuntimeContextSystemContext, t as buildCurrentInboundPrompt } from "./runtime-context-prompt-jCOB3M6y.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply--FnnDs-5.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./plugins/hook-runner-global.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-BKeMGnBY.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-CeCG9dtw.js"));
