...
import { y as runFfmpeg } from "./media-services-Di9wZ6pu.js";
import { i as mergeModelProviderRequestOverrides, l as sanitizeConfiguredModelProviderRequest, u as sanitizeConfiguredProviderRequest } from "./provider-request-config-C5riPuMI.js";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-4cQ_JYCX.js";
import { t as describeImageWithModel } from "./image-runtime-CE59I2Hc.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-5vRBDqE0.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-CisQt5tP.js";
import { n as providerOperationRetryConfig } from "./operation-retry-YXfp5nvn.js";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-DRicDjzl.js";
import { t as applyTemplate } from "./templating-pGedJw5n.js";
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-DcydEyRD.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-B2GLD33r.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-5DzlOm4z.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio",
			workspaceDir: params.workspaceDir
