...
import { l as isValidEnvSecretRefId, m as resolveSecretInputRef } from "./types.secrets-CJS3n8Im.js";
...
import { t as resolveConfiguredSecretInputString } from "./resolve-configured-secret-input-string-D5EDzwcF.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-BIVNJTWQ.js";
...
import { c as normalizeGatewayTokenInput, m as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-BswPaHEg.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-Ca4oyIwh.js";
import { t as runSetupWizard } from "./setup-DvoRJAnL.js";
import { t as createNonInteractiveLoggingPrompter } from "./non-interactive-prompter-CQ0UD7Vw.js";
import { i as applySkipBootstrapConfig, r as applyLocalSetupWorkspaceConfig } from "./onboard-config-V93tm8U5.js";
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-CHb2Gtre.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-ifnFtTUA.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-C-U1h0Hx.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-CO9qHOtq.js");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-BAGy5ZEr.js");
