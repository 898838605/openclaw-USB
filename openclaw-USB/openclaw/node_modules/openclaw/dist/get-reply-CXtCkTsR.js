...
import { C as hasSessionAutoModelFallbackProvenance, _ as resolveSessionAgentId, f as resolveAgentSkillsFilter, p as resolveAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-Cf7T6Ju7.js";
...
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-DUwbsKjv.js";
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-DgUPESoD.js";
import { s as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-BxWkpxUl.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-CRqUrRLW.js";
...
import { g as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-CvQif4jm.js";
import "./config-CR6nsEzH.js";
import { a as normalizeAnyChannelId } from "./registry-O-m2UOqu.js";
import "./message-channel-core-rsgWXY6u.js";
import { r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-JqYBZqnL.js";
import { o as isInterSessionInputProvenance, r as annotateInterSessionPromptText } from "./input-provenance-uYZeqLog.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-codex-routing-17ICsBr_.js";
import { t as resolveAgentHarnessPolicy } from "./policy-DYe4G92j.js";
import { s as resetRegisteredAgentHarnessSessions } from "./registry-Bzhk9nmO.js";
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-CKF4eCEZ.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-Ci62WSre.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-BIlePcj4.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-BuB7h14N.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-RbVDOqFp.js";
import { A as resolveSessionStoreEntry, C as parseSessionThreadInfoFast, t as loadSessionStore, y as resolveMaintenanceConfigFromInput } from "./store-load-DjaY7SAt.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-BscvFMYw.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-OCFvwkK7.js";
import { f as deriveSessionMetaPatch, g as resolveGroupSessionKey, s as updateSessionStore } from "./store-CmwzJ9N6.js";
import { t as normalizeChatType } from "./chat-type-IZp5kgRa.js";
import "./plugins-Cs-ACH2d.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-CvORIrpN.js";
import { c as resolveSessionLifecycleTimestamps } from "./sessions-BDnaolrd.js";
import { c as resolveSessionResetPolicy, i as resolveThreadFlag, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-CX-zoWBz.js";
import { n as resolveSessionKey } from "./session-key-B5xoqibm.js";
import { l as resolveAndPersistSessionFile } from "./transcript-BEv_N5f2.js";
import { x as resolveModelRefFromString } from "./model-selection-shared-CDpQv6TV.js";
import { n as modelKey } from "./model-selection-normalize-mHTe5OFG.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog } from "./model-selection-BKKLDOm5.js";
import { r as loadModelCatalog } from "./model-catalog-Nx2O35da.js";
import { t as resolveAgentTimeoutMs } from "./timeout-Dkhxn08A.js";
import { a as isNativeCommandTurn, c as resolveCommandTurnTargetSessionKey, s as resolveCommandTurnContext } from "./command-turn-context-BtFH5p2Y.js";
import { a as enqueueSystemEvent } from "./system-events-Coh4mKQt.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-BlOFOAQM.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-XNH_y2B4.js";
import { c as getQueueSize, r as clearCommandLane } from "./command-queue-CQS64N4-.js";
import { r as getSessionBindingService } from "./session-binding-service-CYOKTouv.js";
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-7jVKerRx.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-DBJpi3xm.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-D-UWDWG8.js";
import { Ct as isReasoningTagProvider } from "./selection-Cr-9-UpD.js";
import { i as HEARTBEAT_TRANSCRIPT_PROMPT, u as stripHeartbeatToken } from "./heartbeat-BCpYGBga.js";
import { p as buildAgentHookContextChannelFields } from "./attempt.prompt-helpers-CiOyBHXW.js";
import { i as generateSecureToken } from "./secure-random-CNLiQP3k.js";
import { l as ensureAgentWorkspace } from "./workspace-DNgRLjQy.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-De3q8j8x.js";
import { y as collectTextContentBlocks } from "./attempt.tool-run-context-D_w-VPuV.js";
import { c as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-kBY5eAjg.js";
import "./pi-bundle-mcp-tools-DhOKiIBF.js";
import "./delivery-context-Dq1H4ZT9.js";
import { i as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-C_PTy4XI.js";
import { s as getMediaDir } from "./store-BXoGMoVY.js";
import { t as resolveQueueSettings } from "./queue-qrjrdX1U.js";
import { t as buildOutboundSessionContext } from "./session-context-BEwZIs-6.js";
import { n as resolveParentForkDecision, t as forkSessionFromParent } from "./session-fork-DXfx6ETg.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-nLqHLSOM.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-Bt3D_UfY.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as isSystemEventProvider } from "./typing-policy-DPJ4Yg8L.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-kHzcuhlz.js";
import { n as shouldHandleTextCommands } from "./commands-text-routing-CDXX9zWn.js";
import "./commands-registry-QgNf4rX0.js";
import { t as parseSoftResetCommand } from "./commands-reset-mode-DaRRuMGW.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-DZxlOMaP.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-DPHCcHNN.js";
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-Bn7Z8huA.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-DIcmPEr1.js";
import { t as finalizeInboundContext } from "./inbound-context-Nazg_p6J.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-CSIjZAQb.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-7feHeE6H.js";
import { a as buildSessionStartHookPayload, i as buildSessionEndHookPayload, r as noteActiveSessionForShutdown, t as forgetActiveSessionForShutdown } from "./active-sessions-shutdown-tracker-B1nE2K2z.js";
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-D-kecVQ9.js";
import { t as closeTrackedBrowserTabsForSessions } from "./browser-maintenance-CWSUSD7G.js";
import { t as hasControlCommand } from "./command-detection-BQjcGMBC.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-CqM7X9Yo.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-CDg4yTY7.js";
import { t as resolveChannelModelOverride } from "./model-overrides-Cgtq8qIR.js";
import { t as normalizeGroupActivation } from "./group-activation-CJMkhaCv.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-B83-W_qE.js";
import { t as resolveFastModeState } from "./fast-mode-CJ-bUYWt.js";
import { i as hasInboundMedia, s as resolveBlockStreamingChunking } from "./agent-turn-attachments-2gx0wYAA.js";
import { t as buildCommandContext } from "./commands-context-BELOMcP6.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-oN3nTrpG.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-BvQdYOAC.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-D42a8MYM.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-ulTEDq0J.js";
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-KM_v-MUA.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-wQ3NLRVZ.js";
...
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-Bd1k3hR-.js";
import { i as resolveCurrentTurnImages, n as resolveTypingMode, o as resolveSilentReplySettings, r as resolveActiveRunQueueAction } from "./typing-mode-D44I4YRQ.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-CWLbYkOu.js";
...
import { t as drainFormattedSystemEventBlock } from "./session-system-events-DMmYxC44.js";
import { r as getCliSessionBinding } from "./cli-session-CszlfVr5.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-VGJZKDAi.js";
import { t as isResetAuthorizedForContext } from "./reset-authorization-BPsn776D.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-DfIk_3JX.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-D5Q5brwV.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-DfWi-JFq.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-5BprPTAP.js"));
...
function loadDeliverRuntime() {
	messageRuntimePromise ??= import("./runtime-D1yJLQPy.js");
...
const originRoutingLoader = createLazyImportLoader(() => import("./origin-routing-DI-bgoQe.js"));
		...
		if (opts?.isHeartbeat) {
			...
			if (heartbeatPending.shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionStoreEntry } = await import("./sessions-BEVhRj-w.js");
