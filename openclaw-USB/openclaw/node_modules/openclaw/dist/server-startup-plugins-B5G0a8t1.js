...
import "./loader-CxUWY2_6.js";
import { F as createEmptyPluginRegistry, a as getActivePluginRegistry, x as setActivePluginRegistry } from "./runtime-nSi6iKFR.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-BL2yUyBJ.js";
import { c as initSubagentRegistry } from "./subagent-registry-Bu5qGLSl.js";
import { t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-OE8vdenN.js";
import { n as listGatewayMethods } from "./server-methods-list-BTlY8U9C.js";
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-DrbpUZyW.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-DQAl_0Tg.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-5vAl5ay7.js");
